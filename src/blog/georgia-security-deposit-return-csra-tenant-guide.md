---
title: "How to Get Your Security Deposit Back in Georgia: CSRA Tenant Guide"
description: "Georgia law gives landlords exactly 30 days to return your deposit. Know your rights under O.C.G.A. § 44-7-34, what deductions are legal, and how to fight back in Augusta-area magistrate court."
date: 2026-07-03
category: "Tenants"
readTime: "10"
keywords: ["security deposit return Georgia", "security deposit tenant rights Georgia", "CSRA rental deposit", "Augusta GA security deposit law", "Georgia tenant security deposit"]
image: "/images/blog/georgia-security-deposit-return-csra-tenant-guide.jpg"
imageAlt: "Clean bright rental home interior with freshly vacuumed carpet and warm afternoon light through windows"
socialImage: "/images/blog/georgia-security-deposit-return-csra-tenant-guide-social.jpg"
socialImageAlt: "Move-out inspection clipboard with house keys on wooden table"
socialTeaser: |
  We get this call every summer: a tenant cleaned the place spotless, handed over the keys, gave a forwarding address — and then waited. And waited.

  Here's what Georgia law actually says. Under O.C.G.A. § 44-7-34, your landlord has exactly 30 days from the day you move out to return your full deposit or send you a written itemized statement of any deductions. Miss that deadline and they forfeit their right to keep a single dollar — it's all yours, and a magistrate court judge in Augusta or Columbia County can order them to pay up to three times the wrongfully withheld amount.

  What landlords typically can deduct: unpaid rent, damage beyond normal wear, and excessive cleaning. What they cannot: scuffed baseboards, nail holes from pictures, or paint that faded over a three-year tenancy.

  Document everything before you hand in your keys. Request a joint walkthrough. Submit your notice in writing with a forwarding address.

  Read the full breakdown →
  https://mcbride-pm.com/blog/georgia-security-deposit-return-csra-tenant-guide/
author: "Noah McBride"
authorTitle: "Principal Broker"
faqs:
  - question: "How long does a Georgia landlord have to return my security deposit?"
    answer: "Under O.C.G.A. § 44-7-34, your landlord must return your full deposit — or send a written itemized statement explaining any deductions — within 30 days of the date you vacate the property and provide a forwarding address. The clock starts on whichever comes later."
  - question: "Can a Georgia landlord deduct for normal wear and tear?"
    answer: "No. Deductions for normal wear and tear — faded paint, minor wall scuffs, carpet worn by regular foot traffic, small picture-hanging holes — are not permitted under Georgia law. Landlords can only deduct for actual damage beyond normal use, unpaid rent, or cleaning costs that exceed what a standard turnover requires."
  - question: "What happens if a Georgia landlord doesn't return my deposit within 30 days?"
  ...
  - question: "How much security deposit can a Georgia landlord charge?"
    answer: "Under amendments tied to Georgia's Safe at Home Act, landlords are limited to no more than two months' rent as a security deposit. Georgia also requires landlords to hold deposits in a separate escrow account or post a surety bond with the superior court clerk within five business days of receiving the funds."
  - question: "How do I dispute a security deposit deduction in Georgia?"
  ...
  - question: "What should I do before moving out to protect my security deposit?"
    answer: "Document the property's condition with photos or video before you return keys. Request a joint move-out walkthrough with your landlord or property manager. Submit your move-out notice in writing with your forwarding address. Clean beyond normal expectations and repair minor damage you caused. Keep copies of all correspondence."
---

<div class="snippet-box">

**How long does a Georgia landlord have to return a security deposit, and what can they deduct?**
Under [O.C.G.A. § 44-7-34](https://law.justia.com/codes/georgia/title-44/chapter-7/article-2/section-44-7-34/), a Georgia landlord must return your security deposit — or mail you a written itemized statement of deductions — within **30 days** of move-out. They can only keep money for unpaid rent, actual damage beyond normal wear, or cleaning costs beyond standard turnover. Missing the 30-day window forfeits their right to withhold anything, and bad-faith withholding can trigger triple damages in magistrate court.
...
The core of Georgia's security deposit rules lives in [O.C.G.A. §§ 44-7-30 through 44-7-37](https://law.justia.com/codes/georgia/title-44/chapter-7/article-2/). These sections are short, clear, and worth knowing.
...
These requirements were reinforced and extended by Georgia's [Safe at Home Act](https://nlihc.org/resource/georgia-passes-new-tenant-protection-law-renters-establishing-minimum-habitability), which also established minimum habitability standards and capped deposits at two months' rent. This is general guidance from a property manager — not legal advice; talk to a Georgia attorney for your specific situation.
...
<figure class="blog-figure">
  <img src="/images/blog/georgia-security-deposit-return-csra-tenant-guide-2.jpg" alt="Move-out inspection clipboard with house keys and rental property checklist on clean wooden desk" loading="lazy" width="1408" height="768">
</figure>
...
- Submit a written [30-day notice to vacate](/pdfs/McBride-PM_30-Day-Notice-to-Vacate.pdf). Even if your lease ends on a fixed date, many leases require written notice. Verbal notice is not sufficient. Send it in a way you can document — certified mail, or email with a read receipt.
...
**Final cleaning:**
Go beyond what you'd normally do. Oven interior, refrigerator coils, inside cabinet shelves, blinds, baseboards, bathroom grout — these are common sources of deductions, and cleaning them costs you an afternoon, not a cleaning bill.
...
- Download and complete the [McBride PM Move-Out Inspection Checklist](/pdfs/McBride-PM_Move-Out-Inspection-Checklist.pdf) as your own room-by-room record — even if you're not a McBride PM resident. The checklist covers every area a property manager will inspect.
...
The [Georgia Attorney General's Consumer Protection Division](https://consumer.georgia.gov/resolve-your-dispute/other-options-resolving-your-dispute) also handles complaints about landlord misconduct and can, in some cases, apply additional pressure before a formal court filing becomes necessary.

<figure class="blog-figure">
  <img src="/images/blog/georgia-security-deposit-return-csra-tenant-guide-3.jpg" alt="Clean freshly painted empty room with hardwood floors and natural light streaming through window" loading="lazy" width="1408" height="768">
</figure>
...
Amber McBride manages our resident offboarding process directly. If you're a current resident with questions about your move-out timeline or the condition report, her team is reachable at [ops@mcbride-pm.com](mailto:ops@mcbride-pm.com) or through your AppFolio resident portal.
...
If you're still searching for your next rental in the CSRA, our current [available rentals](/rentals/) page is updated in real time. We manage homes across [Evans](/evans/), Grovetown, [Martinez](/martinez/), [Augusta](/augusta/), and [North Augusta](/north-augusta/).

For a deeper look at your rights as a Georgia renter — including habitability, repairs, and your right to quiet enjoyment — the [Georgia Tenant Rights 2026 guide](/blog/georgia-tenant-rights-2026-csra-renter-guide/) covers all of it.

---

## One More Thing: Understand the Landlord's Side Too

Before you go to court over a disputed deduction, it helps to read the situation from the other side. The [security deposit guide written for CSRA landlords](/blog/security-deposit-best-practices-georgia/) explains exactly what property managers are supposed to document at move-in and what evidence they need to support a deduction.
...
<div class="faq-item">
<div class="faq-question">How long does a Georgia landlord have to return my security deposit?</div>
<div class="faq-answer">Under O.C.G.A. § 44-7-34, your landlord must return your full deposit — or send a written itemized statement explaining any deductions — within 30 days of the date you vacate the property and provide a forwarding address. The clock starts on whichever comes later.</div>
</div>
<div class="faq-item">
<div class="faq-question">Can a Georgia landlord deduct for normal wear and tear?</div>
<div class="faq-answer">No. Deductions for normal wear and tear — faded paint, minor wall scuffs, carpet worn by regular foot traffic, small picture-hanging holes — are not permitted under Georgia law. Landlords can only deduct for actual damage beyond normal use, unpaid rent, or cleaning costs that exceed what a standard turnover requires.</div>
</div>
<div class="faq-item">
<div class="faq-question">What happens if a Georgia landlord doesn't return my deposit within 30 days?</div>
<div class="faq-answer">If the landlord fails to return your deposit or provide an itemized deduction statement within the 30-day window, they forfeit their right to withhold any portion of the deposit. You can file in Georgia magistrate court (small claims, up to $15,000) and may recover up to three times the wrongfully withheld amount plus attorney fees if the court finds bad faith.</div>
</div>
<div class="faq-item">
<div class="faq-question">How much security deposit can a Georgia landlord charge?</div>
<div class="faq-answer">Under amendments tied to Georgia's Safe at Home Act, landlords are limited to no more than two months' rent as a security deposit. Georgia also requires landlords to hold deposits in a separate escrow account or post a surety bond with the superior court clerk within five business days of receiving the funds.</div>
</div>
<div class="faq-item">
<div class="faq-question">How do I dispute a security deposit deduction in Georgia?</div>
<div class="faq-answer">Start with a written demand letter to the landlord by certified mail, referencing O.C.G.A. § 44-7-34 and demanding return of the improperly withheld amount within a specific timeframe. If no response, file a claim in the magistrate court for your county. Richmond County handles Augusta cases; Columbia County handles Evans and Grovetown cases.</div>
</div>
<div class="faq-item">
<div class="faq-question">What should I do before moving out to protect my security deposit?</div>
<div class="faq-answer">Document the property's condition with photos or video before you return keys. Request a joint move-out walkthrough with your landlord or property manager. Submit your move-out notice in writing with your forwarding address. Clean beyond normal expectations and repair minor damage you caused. Keep copies of all correspondence.</div>
</div>
</div>
...
Questions about the process? Call our tenant line at **(706) 339-2874** or email [ops@mcbride-pm.com](mailto:ops@mcbride-pm.com).
