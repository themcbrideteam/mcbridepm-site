---
title: "What Augusta-Area Landlords Must Know About SCRA Lease Breaks"
description: "When a Fort Gordon tenant invokes SCRA lease rights, Augusta landlords face strict federal rules. Here's exactly what to do—and what not to do."
date: 2026-05-24
...
faqs:
  ...
  - question: "How much notice does a Fort Gordon tenant have to give before invoking SCRA?"
    answer: "The SCRA requires written notice plus a copy of military orders delivered to the landlord. Termination becomes effective 30 days after the next rent due date following receipt — typically 30 to 60 days depending on when in the month the notice arrives."
  - question: "Can I keep the security deposit when a military tenant invokes SCRA?"
    answer: "You can keep any portion covering actual physical damages beyond normal wear and tear. You cannot withhold the deposit simply because the lease ended early via SCRA. Any prepaid rent covering periods after the effective termination date must be refunded within 30 days."
  - question: "What are Fort Gordon BAH rates in 2026?"
    answer: "2026 Fort Gordon BAH rates increased 6% from 2025. An E-5 with dependents receives $1,890/month; an E-7 with dependents receives $2,190/month. Soldiers with dependents receive approximately 19.7% more than those without. All rates fall under Augusta housing market area MHA GA073."
  - question: "What should Augusta landlords include in a lease when renting to military tenants?"
    answer: "Include a military clause that acknowledges SCRA rights, requires written notice plus orders for early termination, specifies how security deposits are handled on SCRA termination, and designates where prepaid rent refunds should be sent. This prevents disputes and signals you understand the process."
  - question: "What are the penalties for charging a fee after a valid SCRA lease termination?"
    answer: "Significant. Under 50 U.S.C. § 3955 and § 4042, knowingly charging fees or withholding deposits after a valid SCRA termination exposes landlords to civil damages and potential misdemeanor criminal liability for knowingly seizing or holding a service member's property."
howTo:
  name: "How to Process an SCRA Lease Termination as an Augusta-Area Landlord"
  description: "Step-by-step process for Augusta, GA landlords who receive written SCRA lease termination notice from a Fort Gordon military tenant."
  totalTime: "P30D"
  steps:
    - name: "Verify the notice is legally valid"
      text: "Confirm you have received written notice plus a copy of the military orders. Verbal notice and text messages do not meet SCRA requirements. If either element is missing, respond in writing requesting the missing documentation before any clock starts."
    - name: "Calculate the effective termination date"
      text: "Termination is effective 30 days after the next rent due date following receipt of valid notice. If rent is due the 1st and you receive notice May 15, the next due date is June 1; termination is effective July 1. Document this calculation in writing immediately."
    - name: "Send written acknowledgment to the tenant"
      text: "Confirm the notice received date, the calculated termination date, and move-out inspection scheduling. Written acknowledgment sets expectations and protects you if any dispute arises later."
    - name: "Schedule and conduct the move-out inspection"
      text: "Walk the property with the tenant on or before the effective termination date. Use a standardized move-out checklist and document all conditions with dated photographs."
    - name: "Process the security deposit correctly"
      text: "Apply legitimate damage deductions beyond normal wear and tear per Georgia O.C.G.A. § 44-7-33. You may not deduct for the early termination itself. Provide an itemized statement within the Georgia-required 30-day window."
    - name: "Refund any prepaid rent on time"
      text: "If the tenant prepaid rent covering any period after the effective termination date, refund that prorated amount within 30 days of the termination date, per 50 U.S.C. § 3955(f)(2)."
---

<div class="snippet-box">

**What does SCRA lease termination mean for an Augusta-area landlord?**
...
Not every military situation allows for penalty-free early termination. Under [50 U.S.C. § 3955(b)](https://www.law.cornell.edu/uscode/text/50/3955), three specific circumstances qualify:
...
For landlords managing properties through multiple PCS cycles, [our tenant screening standards](/pdfs/McBride-PM_Tenant-Screening-Standards.pdf) and lease documentation processes are designed with the Fort Gordon market specifically in mind.
...
**Element 1: Written notice of intent to terminate.**
This must be in writing. A verbal conversation does not count. A text message does not count. Valid delivery methods include:
...
**Element 2: A copy of the qualifying military orders.**
The orders document must accompany or closely follow the written notice. If the tenant submits only the notice letter without orders (or vice versa), the package is technically incomplete, and the SCRA clock has not started. Communicate this in writing promptly rather than letting the gap fester — most service members working through legal assistance offices will get you corrected documentation quickly.

When both elements are received, date-stamp receipt immediately. That date is the anchor for all timeline calculations that follow. [McBride Property Management](/services/) logs SCRA notices as soon as they arrive and calendars the critical dates as a standard step in our lease administration process.
...
The consequences for getting this wrong go beyond civil liability. Under [50 U.S.C. § 3955(h) and § 4042](https://www.consumerfinance.gov/consumer-tools/educator-tools/servicemembers/the-servicemembers-civil-relief-act-scra/), landlords who knowingly charge prohibited fees or seize a service member's property can face misdemeanor criminal charges, in addition to civil damages, attorney's fees, and costs.
...
**Physical damage beyond normal wear and tear.** Holes in walls, carpet stains, broken fixtures, pet damage where an addendum applied — all of this is still fair game for security deposit deductions. [Your standard Georgia security deposit process](/blog/security-deposit-best-practices-georgia/) applies unchanged. Document move-out conditions with dated photographs and written itemization.
...
Under [50 U.S.C. § 3955(f)(2)](https://www.militaryonesource.mil/deployment/pre-deployment/military-clause-terminate-your-lease-due-to-deployment-or-pcs/), prepaid rent covering any period after the effective termination date must be returned to the tenant within 30 days of the termination date.
...
2026 BAH rates at Fort Gordon increased 6% from 2025, applying under Augusta housing market area MHA GA073. Confirmed rates from [MyBaseGuide](https://mybaseguide.com/base/fort-gordon/bah) and [Military.com](https://www.military.com/benefits/military-pay/basic-allowance-for-housing):
...
For further context on [owner financial benchmarks in the CSRA](/owner-faqs/), including average vacancy periods and turnover costs across Evans and Columbia County, our owner FAQ page covers the data behind those decisions.
...
For landlords managing their first SCRA termination — or managing properties from out of state — that structured approach changes a stressful situation into a routine one. You can [review our full services](/services/) to see how lease administration is handled, or [download the CSRA Landlord Field Guide](/pdfs/McBride-PM_CSRA-Landlord-Field-Guide.pdf) for a 12-page overview of what landlord operations look like in this market, including lease term guidance and tenant turnover benchmarks.

<div class="faq-section">
<div class="faq-item">
<div class="faq-question">Can a military tenant break a lease in Georgia without penalty under the SCRA?</div>
<div class="faq-answer">Yes. Under 50 U.S.C. § 3955, any active-duty service member with valid PCS or deployment orders of 90 or more days can terminate a residential lease without penalty. No early termination fee is permitted. Normal security deposit deductions for actual damage beyond normal wear and tear still apply.</div>
</div>
<div class="faq-item">
<div class="faq-question">How much notice does a Fort Gordon tenant have to give before invoking SCRA?</div>
<div class="faq-answer">The SCRA requires written notice plus a copy of military orders delivered to the landlord. Termination becomes effective 30 days after the next rent due date following receipt — typically 30 to 60 days depending on when in the month the notice arrives.</div>
</div>
<div class="faq-item">
<div class="faq-question">Can I keep the security deposit when a military tenant invokes SCRA?</div>
<div class="faq-answer">You can keep any portion covering actual physical damages beyond normal wear and tear. You cannot withhold the deposit simply because the lease ended early via SCRA. Any prepaid rent covering periods after the effective termination date must be refunded within 30 days.</div>
</div>
<div class="faq-item">
<div class="faq-question">What are Fort Gordon BAH rates in 2026?</div>
<div class="faq-answer">2026 Fort Gordon BAH rates increased 6% from 2025. An E-5 with dependents receives $1,890/month; an E-7 with dependents receives $2,190/month. Soldiers with dependents receive approximately 19.7% more than those without. All rates fall under Augusta housing market area MHA GA073.</div>
</div>
<div class="faq-item">
<div class="faq-question">What should Augusta landlords include in a lease when renting to military tenants?</div>
<div class="faq-answer">Include a military clause that acknowledges SCRA rights, requires written notice plus orders for early termination, specifies how security deposits are handled on SCRA termination, and designates where prepaid rent refunds should be sent. This prevents disputes and signals you understand the process.</div>
</div>
<div class="faq-item">
<div class="faq-question">What are the penalties for charging a fee after a valid SCRA lease termination?</div>
<div class="faq-answer">Significant. Under 50 U.S.C. § 3955 and § 4042, knowingly charging fees or withholding deposits after a valid SCRA termination exposes landlords to civil damages and potential misdemeanor criminal liability for knowingly seizing or holding a service member's property.</div>
</div>
</div>
