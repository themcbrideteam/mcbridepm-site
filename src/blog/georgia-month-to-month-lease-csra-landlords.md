---
title: "Georgia Month-to-Month Lease: What CSRA Landlords Must Know"
description: "Month-to-month lease rules for Georgia landlords: the 60-day notice law, holdover tenancy traps, and when MTM is the right call for CSRA rental owners."
date: 2026-06-26
category: "Property Owners"
readTime: "11"
keywords: ["month-to-month lease Georgia landlord", "Georgia tenancy at will notice", "CSRA rental lease renewal Augusta", "holdover tenant Georgia", "month-to-month vs fixed term lease Augusta GA"]
image: "/images/blog/georgia-month-to-month-lease-csra-landlords.jpg"
imageAlt: "Home office desk with lease documents, brass house keys, and warm late-afternoon light in a Georgia residential interior"
socialImage: "/images/blog/georgia-month-to-month-lease-csra-landlords-social.jpg"
socialImageAlt: "Brass house keys resting on a warm wooden counter in afternoon light"
socialTeaser: |
  Three Evans landlords called our office this month asking the same question: "My tenant's lease is up August 1 — do I need to sign a new lease, or can we just go month-to-month?" The right answer depends entirely on your situation.

  What most CSRA landlords don't know: if you accept rent from a holdover tenant, Georgia law typically creates a tenancy at will — and that means you now need 60 days' written notice to ask them to leave. Not 30. Not immediate. Sixty days. That's O.C.G.A. § 44-7-7, and it applies whether you intended it or not.

  Month-to-month has real uses — especially during Fort Gordon PCS season when tenant timelines are genuinely uncertain. But it also carries costs most landlords haven't calculated before agreeing to it.

  Read the full breakdown →
  https://mcbride-pm.com/blog/georgia-month-to-month-lease-csra-landlords/
author: "Noah McBride"
authorTitle: "Principal Broker"
faqs:
  - question: "How much notice must a Georgia landlord give to end a month-to-month lease?"
    answer: "Under O.C.G.A. § 44-7-7, a landlord must provide at least 60 days' written notice to terminate a tenancy at will, which governs most month-to-month arrangements. Tenants need only 30 days. This asymmetry is one of the least-understood rules in Georgia rental law and catches landlords off guard at the worst times."
  - question: "Can a Georgia landlord raise rent on a month-to-month tenant?"
    answer: "Yes — Georgia has no rent control statute. But on a month-to-month or at-will tenancy, a rent increase functions like a material lease change, and most rental attorneys recommend at least 60 days' written notice before the new rate takes effect. Check your lease language and consult a Georgia attorney for your situation. This is general guidance, not legal advice."
  - question: "What happens if a tenant stays past their fixed-term lease in Georgia?"
    answer: "If you accept rent from a holdover tenant, Georgia courts typically treat the arrangement as a new tenancy at will under O.C.G.A. § 44-7-6. At that point, the 60-day landlord termination notice rule applies — you cannot simply demand departure in 30 days or less. A written holdover notice or short-term extension agreement prevents this ambiguity."
  - question: "Does the Safe at Home Act (HB 404) apply to month-to-month tenants in Georgia?"
    answer: "Yes. Georgia's habitability requirements under HB 404 apply to all residential tenancies regardless of lease type or term. Month-to-month tenants have the same right to a habitable, safe dwelling as tenants on a 12-month fixed-term lease. Landlords cannot reduce habitability obligations by moving a tenant to month-to-month."
  - question: "Is month-to-month a smart strategy for military tenants near Fort Gordon?"
    answer: "It can be — with proper documentation. Military tenants can terminate a fixed-term lease early under the SCRA regardless, so a fixed term doesn't guarantee a full year's tenancy. A documented month-to-month arrangement can reduce friction around PCS orders, provided BAH alignment is confirmed in writing and the lease includes SCRA language."
  - question: "What is the difference between a tenancy at will and a month-to-month lease in Georgia?"
    answer: "A tenancy at will (O.C.G.A. § 44-7-6) arises when no specific lease term is stated — typically a holdover situation. A written month-to-month lease renews by agreement each month. Georgia courts and the DCA Landlord-Tenant Handbook treat both similarly for termination notice: 60 days from the landlord, 30 days from the tenant."
---

<div class="snippet-box">

**When is a month-to-month lease the right choice for a Georgia rental property?**
Under O.C.G.A. § 44-7-7, Georgia landlords must give 60 days' written notice to end a month-to-month tenancy — but tenants only need 30 days. Month-to-month works well when tenant timelines are genuinely uncertain, but defaulting to it at lease renewal costs most CSRA landlords more flexibility than they gain.
...
## What Georgia Law Actually Says About Month-to-Month Tenancies

Georgia's landlord-tenant statutes don't use the phrase "month-to-month lease" in their core provisions. What they use is **tenancy at will** — a term defined under [O.C.G.A. § 44-7-6](http://ga.elaws.us/law/section44-7-6). A tenancy at will exists when a tenant occupies property with the landlord's consent but without a fixed term stated in a written agreement. The most common way this arises: a fixed-term lease expires and neither party formalizes the continuation.
...
**[O.C.G.A. § 44-7-7](http://ga.elaws.us/law/section44-7-7):** To terminate a tenancy at will, the landlord must give **60 days' written notice**. The tenant must give **30 days**. This is not 30 days from the next rent due date — it is 60 calendar days from the date the written notice is delivered.

The [Georgia DCA Landlord-Tenant Handbook](https://dca.georgia.gov/document/publications/georgia-landlord-tenant-handbook/download) — the state's official reference for residential rentals — confirms this framework and is worth reading once if you own rentals in Georgia. It's available free as a PDF from the Department of Community Affairs.
...
## The 60-Day Rule: The Asymmetry Most CSRA Landlords Underestimate
...
<figure class="blog-figure">
  <img src="/images/blog/georgia-month-to-month-lease-csra-landlords-2.jpg" alt="Fountain pen resting on a rental lease renewal agreement on an oak desk in warm window light" loading="lazy" width="1408" height="768">
</figure>

## How a Holdover Tenancy Happens — and Why It Creates Risk
...
- Send a lease expiration reminder at least **60 days before the end date** — not 30, not 45, but 60. This gives you room to process either a renewal or a non-renewal without overlap.
- If the tenant is staying, present a written renewal or month-to-month agreement **before the lease expires**.
- If you need a short bridge extension, put it in writing: a signed letter stating the extension end date and its terms. Even a one-paragraph email confirmed by both parties is better than silence.
- If the tenant is not renewing, send a written non-renewal notice at least 60 days before expiration so you're clear of holdover ambiguity before the lease ends.

The [Georgia lease clauses guide on our blog](/blog/georgia-lease-agreement-clauses-csra-landlords-2026/) covers what a solid holdover clause should say in a CSRA residential lease — including the language that converts a holdover to month-to-month with a specified notice period, rather than defaulting to the bare statutory minimum.

## When Month-to-Month Works in Your Favor as a CSRA Landlord
...
## When Defaulting to Month-to-Month Creates Problems
...
<figure class="blog-figure">
  <img src="/images/blog/georgia-month-to-month-lease-csra-landlords-3.jpg" alt="Empty freshly painted living room with hardwood floors and natural light through tall windows in a Georgia rental home" loading="lazy" width="1408" height="768">
</figure>

## The Five-Step Lease Decision Framework for CSRA Landlords

If you have a lease expiring between July 1 and September 30, 2026, here is the decision sequence:

**Step 1: Assess the tenant's record.**
A tenant with 12 months of on-time payments, no unreported damage, and no lease violations is worth retaining. The average CSRA make-ready costs $1,500–$3,500 when you factor in cleaning, fresh paint, and minor repairs — and that's before the vacancy days at roughly $40–$70 per day on a typical Columbia County single-family rental. Turnover is expensive. A reliable tenant is an asset.

**Step 2: Decide your 12-month timeline.**
Will you want this property available for sale, major renovation, or reconfiguration within the next year? If yes, month-to-month may serve you — but document the arrangement and keep the 60-day clock in mind. If no, a 12-month renewal stabilizes your income and keeps the lease terms current.

**Step 3: Send a written renewal offer at least 60 days before the lease expires.**
Even if you expect the tenant to stay, send the renewal offer in writing. This opens a documented negotiation, gives you a clean vehicle to adjust rent, and prevents the holdover ambiguity. If the tenant declines, you have 60 days to market the property before the lease expires. If they accept, you have a fully executed, updated lease going into the next year.

**Step 4: If month-to-month is the right call, document it explicitly.**
A signed month-to-month addendum should specify: the monthly rent amount, the notice period (you can set 30-day mutual notice by contract — statute governs only in the absence of a written agreement), the property condition at conversion, and an acknowledgment that the tenancy is at-will. Our [owner resources page](/resources/) has downloadable templates, and the [CSRA Landlord Field Guide](/pdfs/McBride-PM_CSRA-Landlord-Field-Guide.pdf) has a section on documenting tenancy transitions cleanly.

**Step 5: Update your lease terms regardless of which path you choose.**
At every renewal — fixed-term or month-to-month — review your lease for Safe at Home Act compliance (habitability language, mold provisions, flood disclosure where applicable), the two-month security deposit cap under Georgia law, and any local Columbia County or Richmond County notice requirements. A lease that hasn't been updated since 2023 is likely missing clauses that matter. For a checklist of what to update, the [lease renewal strategies guide](/blog/lease-renewal-strategies-augusta-ga-landlords/) walks through the annual review process in detail.

## Safe at Home Act Obligations Apply Regardless of Lease Type
...
For a complete breakdown of HB 404 requirements, our [Safe at Home Act guide for Augusta landlords](/blog/georgia-safe-at-home-act-landlord-guide-augusta-ga/) covers the habitability standard, required disclosures, and deposit rules in detail.

## Getting the Lease Decision Right Every Year
...
<div class="faq-item">
<div class="faq-question">How much notice must a Georgia landlord give to end a month-to-month lease?</div>
<div class="faq-answer">Under O.C.G.A. § 44-7-7, a landlord must provide at least 60 days' written notice to terminate a tenancy at will, which governs most month-to-month arrangements. Tenants need only 30 days. This asymmetry is one of the least-understood rules in Georgia rental law and catches landlords off guard at the worst times.</div>
</div>
<div class="faq-item">
<div class="faq-question">Can a Georgia landlord raise rent on a month-to-month tenant?</div>
<div class="faq-answer">Yes — Georgia has no rent control statute. But on a month-to-month or at-will tenancy, a rent increase functions like a material lease change, and most rental attorneys recommend at least 60 days' written notice before the new rate takes effect. Check your lease language and consult a Georgia attorney for your situation. This is general guidance, not legal advice.</div>
</div>
<div class="faq-item">
<div class="faq-question">What happens if a tenant stays past their fixed-term lease in Georgia?</div>
<div class="faq-answer">If you accept rent from a holdover tenant, Georgia courts typically treat the arrangement as a new tenancy at will under O.C.G.A. § 44-7-6. At that point, the 60-day landlord termination notice rule applies — you cannot simply demand departure in 30 days or less. A written holdover notice or short-term extension agreement prevents this ambiguity.</div>
</div>
<div class="faq-item">
<div class="faq-question">Does the Safe at Home Act (HB 404) apply to month-to-month tenants in Georgia?</div>
<div class="faq-answer">Yes. Georgia's habitability requirements under HB 404 apply to all residential tenancies regardless of lease type or term. Month-to-month tenants have the same right to a habitable, safe dwelling as tenants on a 12-month fixed-term lease. Landlords cannot reduce habitability obligations by moving a tenant to month-to-month.</div>
</div>
<div class="faq-item">
<div class="faq-question">Is month-to-month a smart strategy for military tenants near Fort Gordon?</div>
<div class="faq-answer">It can be — with proper documentation. Military tenants can terminate a fixed-term lease early under the SCRA regardless, so a fixed term doesn't guarantee a full year's tenancy. A documented month-to-month arrangement can reduce friction around PCS orders, provided BAH alignment is confirmed in writing and the lease includes SCRA language.</div>
</div>
<div class="faq-item">
<div class="faq-question">What is the difference between a tenancy at will and a month-to-month lease in Georgia?</div>
<div class="faq-answer">A tenancy at will (O.C.G.A. § 44-7-6) arises when no specific lease term is stated — typically a holdover situation. A written month-to-month lease renews by agreement each month. Georgia courts and the DCA Landlord-Tenant Handbook treat both similarly for termination notice: 60 days from the landlord, 30 days from the tenant.</div>
</div>
</div>
