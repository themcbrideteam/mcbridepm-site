---
title: "Section 121 Military Exception for Fort Gordon PCS Landlords"
description: "When Fort Gordon PCS orders turn your home into a rental, the §121 military exception can save Augusta-area landlords thousands in capital gains taxes."
date: 2026-06-16
category: "Property Owners"
readTime: "10"
keywords: ["section 121 military exclusion PCS landlord", "Fort Gordon PCS capital gains Georgia", "military home sale exclusion Augusta GA", "section 121 suspension rental property military", "Fort Gordon landlord sell rental capital gains"]
image: "/images/blog/section-121-military-exception-fort-gordon-pcs-landlords.jpg"
imageAlt: "Brick ranch home on a tree-lined Evans Georgia residential street in late-afternoon golden hour light"
socialImage: "/images/blog/section-121-military-exception-fort-gordon-pcs-landlords-3.jpg"
socialImageAlt: "Home office with laptop on wooden desk in warm natural light"
socialTeaser: |
  Sixteen CSRA military landlords called us this year with the same question: they got PCS orders years ago, rented their Fort Gordon-area home, and now want to know if they've lost the $500,000 capital gains exclusion.

  Most assume they have. Most are wrong.

  Under IRC §121(d)(9), active-duty service members stationed at least 50 miles from their home can suspend the standard 5-year look-back clock for up to 10 additional years—giving you a 15-year window to still qualify. Depreciation recapture still applies, but the appreciation gain? That may be entirely protected.

  Read the full breakdown →
  https://mcbride-pm.com/blog/section-121-military-exception-fort-gordon-pcs-landlords/
author: "Noah McBride"
authorTitle: "Principal Broker"
faqs:
  - question: "Does the §121 military suspension apply to both spouses on a joint return?"
    answer: "Yes. If either spouse serves on qualified official extended duty—stationed at least 50 miles from the home or living in government quarters under orders for more than 90 days—both spouses can use the suspension when filing jointly, as long as they also meet the joint ownership and residency requirements."
  - question: "Can I suspend the five-year clock on more than one property at the same time?"
    answer: "No. The IRS allows the §121 military suspension on only one property at a time. If you own two potential principal residences and receive PCS orders, you must choose which property's clock to suspend for that period of qualifying service."
  - question: "Does depreciation recapture disappear if I qualify for the §121 military exclusion?"
    answer: "No. The §121 exclusion only offsets your capital gain above your adjusted basis. Depreciation you claimed—or were required to claim—after May 6, 1997, is still subject to unrecaptured §1250 gain tax at a maximum federal rate of 25%, regardless of the military exception."
  - question: "What happens to the clock if I retire from active duty without selling?"
    answer: "When your qualifying military service ends—at retirement, separation, or when your duty station moves within 50 miles of the property—the regular 5-year clock resumes from where it left off. The suspended years are excluded from the count; the clock does not reset to zero."
  - question: "Does the rental period during qualifying military service count as non-qualified use?"
    answer: "Under §121(d)(9), any period of qualifying military service (up to 10 years aggregate) is explicitly excluded from the definition of non-qualified use under §121(b)(5). This means your exclusion is not reduced pro-rata for time your home was rented during qualifying active duty—a protection many military landlords overlook."
  - question: "What if I bought the house as an investment and never lived in it as my primary residence?"
    answer: "The §121 exclusion and the military suspension apply only to a property that served as your principal residence. If you purchased the home as an investment without ever establishing it as your primary home, neither provision applies, and gain on sale is fully taxable as capital gain."
howTo:
  name: "How to Apply the §121 Military Exception When Selling Your Fort Gordon Rental"
  description: "Step-by-step process for active-duty and retired military landlords to document qualifying service, verify eligibility, and report the §121 military exclusion at sale."
  totalTime: "P6M"
  steps:
    - name: "Establish your primary residence dates"
      text: "Pull closing documents, utility records, and military housing records to document the exact dates you lived in the home as your principal residence. You need at least 24 months of documented primary residence during the qualifying look-back period."
    - name: "Document your PCS orders and duty station locations"
      text: "Gather every set of PCS orders and duty station documentation showing the dates you were stationed at least 50 miles from the home, or residing in government quarters under orders. This is the record you will use to support the suspension election."
    - name: "Confirm the one-property limit"
      text: "Verify you were not simultaneously suspending the five-year clock on another property during the same period. The IRS allows only one property at a time. If you have two candidate properties, document which one you are designating for each service period."
    - name: "Calculate your adjusted basis and anticipated gain"
      text: "Work with a CPA to calculate your adjusted basis—purchase price plus qualified improvements minus all depreciation claimed or allowable—and your expected gain at sale. Identify what portion is excludable under §121 and what portion is depreciation recapture subject to tax regardless."
    - name: "Decide whether you need the suspension election"
      text: "If you still meet the 2-of-5-year primary residence test without the suspension, you may not need to elect it. If you do not meet the test without it, confirm the election with your CPA and plan to report it on Schedule D and Form 8949 in the year of sale."
    - name: "Report the sale and exclusion correctly on your return"
      text: "Report the sale on Schedule D (Form 1040). The §121 exclusion amount is reported on Form 8949. Unrecaptured §1250 gain (depreciation recapture) is computed on the dedicated worksheet in the Schedule D instructions and reported separately. Do not combine them."
---

<div class="snippet-box">

**When Fort Gordon PCS orders turn your home into a rental, can you still exclude up to $500,000 in capital gains when you eventually sell?**
...
Under [Internal Revenue Code §121](https://www.law.cornell.edu/uscode/text/26/121), homeowners who have **owned** AND **used** a property as their principal residence for at least 2 of the 5 years ending on the date of sale can exclude up to $250,000 of capital gain from federal income taxes—or $500,000 for married couples filing jointly.
...
That is where [§121(d)(9)](https://www.law.cornell.edu/uscode/text/26/121) changes everything.
...
[IRS Publication 523 (2025 edition)](https://www.irs.gov/publications/p523) explains it this way: "You can choose to have the 5-year test period for ownership and use suspended during any period you or your spouse serves on qualified official extended duty as a member of the Armed Forces."
...
If you're still in the early years of renting out your Fort Gordon-area home and haven't sorted out the management side yet, our [PCS landlord 60-day action plan](/blog/pcs-fort-gordon-rent-home-landlord-timeline/) covers what to set up before you leave—so your options at sale, years from now, are protected.

<figure class="blog-figure">
  <img src="/images/blog/section-121-military-exception-fort-gordon-pcs-landlords-2.jpg" alt="Wooden desk with manila folder and house keys in warm afternoon window light" loading="lazy" width="1408" height="768">
</figure>
...
The suspension only applies during periods of **qualified official extended duty**, defined in [IRS Publication 3, Armed Forces' Tax Guide](https://www.irs.gov/publications/p3) as meeting both of the following conditions:
...
One critical point: **do not skip claiming depreciation to try to avoid recapture.** The IRS computes recapture on depreciation you were entitled to claim—not just what you reported. Skipping the deduction costs you the cash benefit now while guaranteeing the same tax liability at sale. The [rental property tax deductions guide](/blog/rental-property-tax-deductions-georgia-landlords/) covers the full depreciation picture for Georgia landlords.

Some PCS landlords in this position also model a [1031 exchange into a replacement property](/blog/1031-exchange-basics-augusta-rental-investors/) as a way to defer both the capital appreciation and the depreciation recapture into a new asset—your CPA can run those numbers alongside the §121 exclusion scenario to see which leaves you better positioned.

<figure class="blog-figure">
  <img src="/images/blog/section-121-military-exception-fort-gordon-pcs-landlords-3.jpg" alt="Laptop showing clean financial dashboard on wooden desk in warm home office light" loading="lazy" width="1408" height="768">
</figure>
...
Second, the 2026 Fort Gordon BAH rates—which rose 4.2% this year—support rent levels that keep your cash flow positive while you wait for the right sale timing. Understanding [what Fort Gordon's mission drives in local rental demand](/blog/fort-eisenhower-military-tenant-rental-demand-augusta/) is worth reviewing before you set or renew your rental price.
...
To keep track of the property information you'll need at sale, download our [CSRA Landlord Field Guide](/pdfs/McBride-PM_CSRA-Landlord-Field-Guide.pdf). If you're still in the early stages of setting up the rental and managing from a distance, the [PCS Landlord Quick-Start Guide](/pdfs/McBride-PM_PCS-Landlord-Quick-Start-Guide.pdf) covers the operational decisions you should make now that will affect your options later.

---

<div class="faq-section">
<div class="faq-item">
<div class="faq-question">Does the §121 military suspension apply to both spouses on a joint return?</div>
<div class="faq-answer">Yes. If either spouse serves on qualified official extended duty—stationed at least 50 miles from the home or living in government quarters under orders for more than 90 days—both spouses can use the suspension when filing jointly, as long as they also meet the joint ownership and residency requirements.</div>
</div>
<div class="faq-item">
<div class="faq-question">Can I suspend the five-year clock on more than one property at the same time?</div>
<div class="faq-answer">No. The IRS allows the §121 military suspension on only one property at a time. If you own two potential principal residences and receive PCS orders, you must choose which property's clock to suspend for that period of qualifying service.</div>
</div>
<div class="faq-item">
<div class="faq-question">Does depreciation recapture disappear if I qualify for the §121 military exclusion?</div>
<div class="faq-answer">No. The §121 exclusion only offsets your capital gain above your adjusted basis. Depreciation you claimed—or were required to claim—after May 6, 1997, is still subject to unrecaptured §1250 gain tax at a maximum federal rate of 25%, regardless of the military exception.</div>
</div>
<div class="faq-item">
<div class="faq-question">What happens to the clock if I retire from active duty without selling?</div>
<div class="faq-answer">When your qualifying military service ends—at retirement, separation, or when your duty station moves within 50 miles of the property—the regular 5-year clock resumes from where it left off. The suspended years are excluded from the count; the clock does not reset to zero.</div>
</div>
<div class="faq-item">
<div class="faq-question">Does the rental period during qualifying military service count as non-qualified use?</div>
<div class="faq-answer">Under §121(d)(9), any period of qualifying military service (up to 10 years aggregate) is explicitly excluded from the definition of non-qualified use under §121(b)(5). This means your exclusion is not reduced pro-rata for time your home was rented during qualifying active duty—a protection many military landlords overlook.</div>
</div>
<div class="faq-item">
<div class="faq-question">What if I bought the house as an investment and never lived in it as my primary residence?</div>
<div class="faq-answer">The §121 exclusion and the military suspension apply only to a property that served as your principal residence. If you purchased the home as an investment without ever establishing it as your primary home, neither provision applies, and gain on sale is fully taxable as capital gain.</div>
</div>
</div>
