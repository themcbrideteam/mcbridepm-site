---
title: "Georgia Rental Pest Control: What Landlords Must Do in 2026"
description: "Under Georgia's Safe at Home Act, pest infestations are now a landlord habitability obligation. CSRA landlords: here's what O.C.G.A. § 44-7-13 requires, who pays, and how to protect yourself."
date: 2026-07-07
category: "Property Owners"
readTime: "10"
keywords: ["pest control rental property Georgia landlord", "Georgia landlord pest infestation responsibility", "Safe at Home Act pest control CSRA", "who pays pest control rental Georgia", "termite landlord responsibility Georgia rental"]
image: "/images/blog/pest-control-rental-property-georgia-landlord-guide.jpg"
imageAlt: "Established brick ranch home on a tree-lined Evans Georgia street in warm summer afternoon light with manicured lawn"
author: "Noah McBride"
authorTitle: "Principal Broker"
faqs:
  - question: "Is a Georgia landlord required to provide pest control?"
    answer: "Not automatically for routine preventive treatment. But Georgia's Safe at Home Act (O.C.G.A. § 44-7-13(b)) requires landlords to address any infestation that makes the unit uninhabitable — regardless of what the lease says. Severe infestations involving roaches, rodents, bed bugs, or termites fall under this warranty."
  - question: "Who is responsible for pest control when a tenant moves in?"
    answer: "The landlord. Any infestation present at move-in is a pre-existing condition the tenant didn't cause. Delivering a pest-free unit is part of the warranty of habitability. A thorough move-in inspection with dated documentation protects both parties and establishes the baseline."
  - question: "Can a Georgia lease put pest control responsibility on the tenant?"
    answer: "Yes, for routine preventive treatment. A lease clause can assign ongoing pest control costs — monthly spraying, for example — to the tenant. It cannot waive the landlord's obligation to address infestations that violate the Safe at Home Act's habitability warranty, and it cannot make tenants responsible for pre-existing conditions or structural pests."
  - question: "How quickly must a Georgia landlord respond to a pest complaint?"
    answer: "The Safe at Home Act requires action within a 'reasonable' time. For habitability-level infestations — rodents, heavy roach colonies, bed bugs — three to five business days is the standard. For active termite activity, treat immediately. For routine seasonal insects, seven to ten business days is generally acceptable."
  - question: "Which pests is a Georgia landlord always responsible for?"
    answer: "Termites (structural pests that damage the property), rodents (which enter through structural gaps), and any infestation severe enough to make the unit uninhabitable — regardless of cause. Routine seasonal insects like ants and mosquitoes can generally be assigned to tenants by lease clause."
  - question: "What does pest control cost for a CSRA rental property?"
    answer: "Quarterly preventive service in the Augusta area runs $75–$120 per visit. One-time roach treatment ranges $150–$450 depending on severity. Rodent treatment and exclusion work runs $300–$800. Active termite treatment costs $500–$2,500 or more. Annual termite bonds for treated properties run $100–$350 per year."
howTo:
  name: "How to Handle a Pest Complaint in Your CSRA Rental Property"
  description: "Step-by-step response protocol for when a tenant reports an infestation, from written notice through licensed treatment and file documentation."
  totalTime: "P14D"
  steps:
    - name: "Receive written notice from the tenant"
      text: "Ask the tenant to send their pest complaint in writing — email, text, or a maintenance ticket through your property management system. Acknowledge receipt the same day. The clock for reasonable response time starts here."
    - name: "Assess infestation type and severity"
      text: "Determine whether this is a routine nuisance (a few ants in summer) or a habitability-level infestation (roach colony, rodents, bed bugs, active termites). Severity determines urgency and who is legally responsible."
    - name: "Contact a licensed Georgia pest control operator"
      text: "Use only a Georgia Department of Agriculture-licensed pest control company. Get an inspection and written report. The written report documents condition and causation — both matter if the situation ever reaches a dispute."
    - name: "Treat within a reasonable time"
      text: "For habitability-level infestations: schedule treatment within three to five business days. For routine seasonal insects: seven to ten business days is generally acceptable. For active termites: treat immediately and notify your insurance carrier."
    - name: "Document everything"
      text: "Keep the inspection report, invoice, and any photographs in the property file. Add a note to the maintenance log. If the matter ever escalates to a habitability dispute, documentation is your primary defense."
    - name: "Evaluate causation before pursuing chargebacks"
      text: "If the infestation was clearly tenant-caused — documented sanitation violations, unauthorized animals, excessive clutter — you may have grounds to charge treatment costs back to the tenant. Consult a Georgia real estate attorney before deducting from the security deposit."
---

<div class="snippet-box">

**Who is responsible for pest control in a Georgia rental property?**
...
Our post on [Georgia's Safe at Home Act](/blog/georgia-safe-at-home-act-landlord-guide-augusta-ga/) covers the full scope of the law's habitability standards — pest control is one component of a broader shift in Georgia landlord-tenant law that every CSRA property owner needs to understand.
...
The Georgia Attorney General's Consumer Education division describes the landlord's obligation this way: [a landlord must provide a rental unit that is safe, sanitary, and habitable](https://consumered.georgia.gov/ask-ed/2012-01-05/landlord-wont-resolve-bug-infestation) — "meaning it is livable." The Consumer Ed office notes specifically that a landlord who ignores a bug infestation after a tenant has reported it may be in violation of this standard. Under the Safe at Home Act, what was previously a matter of legal interpretation is now a statutory requirement.
...
<figure class="blog-figure">
  <img src="/images/blog/pest-control-rental-property-georgia-landlord-guide-2.jpg" alt="Property inspection report and house keys on a clean wooden desk in warm natural light" loading="lazy" width="1408" height="768">
</figure>
...
**Termites — Always the Landlord's Obligation**
...
Pricing benchmarks via [Angi's Atlanta-area pest control cost data](https://www.angi.com/articles/how-much-does-pest-control-service-cost/ga/atlanta) — verify current CSRA pricing directly with licensed operators before budgeting.

<figure class="blog-figure">
  <img src="/images/blog/pest-control-rental-property-georgia-landlord-guide-3.jpg" alt="Bright clean kitchen interior in a Georgia rental home with white cabinets and hardwood floors in morning light" loading="lazy" width="1408" height="768">
</figure>
...
- Address any standing water situation immediately. Mold and pest conditions frequently develop together in the same locations; our post on [mold and moisture in CSRA rental properties](/blog/mold-moisture-rental-property-augusta-ga-landlord-guide/) covers the habitability overlap.

**At Turnover**
Treat between every tenancy, regardless of whether the outgoing tenant reported any issues. German cockroaches in particular can inhabit the motor compartment of a refrigerator for months without being visible during casual inspection. A turnover treatment is part of the [pre-rental prep checklist](/blog/summer-maintenance-checklist-augusta-rental-property/) — one of the highest-ROI maintenance investments before a new tenant moves in.
...
<div class="faq-item">
<div class="faq-question">Is a Georgia landlord required to provide pest control?</div>
<div class="faq-answer">Not automatically for routine preventive treatment. But Georgia's Safe at Home Act (O.C.G.A. § 44-7-13(b)) requires landlords to address any infestation that makes the unit uninhabitable — regardless of what the lease says. Severe infestations involving roaches, rodents, bed bugs, or termites fall under this warranty.</div>
</div>
<div class="faq-item">
<div class="faq-question">Who is responsible for pest control when a tenant moves in?</div>
<div class="faq-answer">The landlord. Any infestation present at move-in is a pre-existing condition the tenant didn't cause. Delivering a pest-free unit is part of the warranty of habitability. A thorough move-in inspection with dated documentation protects both parties and establishes the baseline.</div>
</div>
<div class="faq-item">
<div class="faq-question">Can a Georgia lease put pest control responsibility on the tenant?</div>
<div class="faq-answer">Yes, for routine preventive treatment. A lease clause can assign ongoing pest control costs — monthly spraying, for example — to the tenant. It cannot waive the landlord's obligation to address infestations that violate the Safe at Home Act's habitability warranty, and it cannot make tenants responsible for pre-existing conditions or structural pests.</div>
</div>
<div class="faq-item">
<div class="faq-question">How quickly must a Georgia landlord respond to a pest complaint?</div>
<div class="faq-answer">The Safe at Home Act requires action within a 'reasonable' time. For habitability-level infestations — rodents, heavy roach colonies, bed bugs — three to five business days is the standard. For active termite activity, treat immediately. For routine seasonal insects, seven to ten business days is generally acceptable.</div>
</div>
<div class="faq-item">
<div class="faq-question">Which pests is a Georgia landlord always responsible for?</div>
<div class="faq-answer">Termites (structural pests that damage the property), rodents (which enter through structural gaps), and any infestation severe enough to make the unit uninhabitable — regardless of cause. Routine seasonal insects like ants and mosquitoes can generally be assigned to tenants by lease clause.</div>
</div>
<div class="faq-item">
<div class="faq-question">What does pest control cost for a CSRA rental property?</div>
<div class="faq-answer">Quarterly preventive service in the Augusta area runs $75–$120 per visit. One-time roach treatment ranges $150–$450 depending on severity. Rodent treatment and exclusion work runs $300–$800. Active termite treatment costs $500–$2,500 or more. Annual termite bonds for treated properties run $100–$350 per year.</div>
</div>
</div>
