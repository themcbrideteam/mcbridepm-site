---
title: "Move-In and Move-Out Inspections: Georgia Landlord's Guide"
description: "Georgia's O.C.G.A. § 44-7-33 sets formal inspection requirements for CSRA rental owners. Skip the written defect list and you may forfeit every security deposit deduction."
date: 2026-07-21
category: "Property Owners"
readTime: "11"
keywords: ["move-in inspection rental property Georgia landlord", "move-out inspection Georgia rental", "security deposit inspection checklist Augusta GA", "Georgia rental property inspection law", "O.C.G.A. 44-7-33 landlord inspection"]
author: "Noah McBride"
authorTitle: "Principal Broker"
socialTeaser: |
  One call we get almost every month in July: a new landlord who skipped the move-in inspection and now has a tenant disputing every deduction. Here's what that costs.

  Under O.C.G.A. § 44-7-33, landlords who use a property management company must provide tenants a signed written damage list before they take possession. That list is legally conclusive. Without it, Georgia makes it nearly impossible to keep any deposit deduction — regardless of what the tenant actually did to your property.

  This is peak move season in the CSRA. Fort Gordon PCS orders, back-to-school timing, and summer lease expirations make July and August the highest-volume turnover months of the year. If you have a tenant turning over right now, this is the guide you need.

  Read the full breakdown →
  https://mcbride-pm.com/blog/move-in-move-out-inspection-rental-property-georgia-landlords/
faqs:
  - question: "Does Georgia law require a move-in inspection?"
    answer: "Yes — for landlords who own more than 10 rental units or who use a property management company. Under O.C.G.A. § 44-7-33 (read with the § 44-7-36 exemption), these landlords must provide a written list of existing defects to the tenant before they take possession, signed by both parties."
  - question: "What happens if I skip the move-in inspection in Georgia?"
    answer: "For covered landlords, failing to provide the initial defect list under § 44-7-33 makes it legally difficult — and often impossible — to withhold any portion of the security deposit for damages at move-out. Courts routinely rule for tenants when no signed baseline exists."
  - question: "How long does a Georgia landlord have to return the security deposit?"
    answer: "30 days after the landlord obtains possession of the premises. Under O.C.G.A. § 44-7-34, the landlord must return the deposit or deliver an itemized written statement of deductions within that window, sent to the tenant's last known address."
  - question: "What can a Georgia landlord deduct from the security deposit?"
    answer: "Unpaid rent, unpaid utility charges the tenant was responsible for, damage beyond normal wear and tear, cleaning required above move-in condition, unpaid late fees, and pet damage when a pet addendum was in effect. Georgia law explicitly prohibits deducting for ordinary wear and tear."
  - question: "What is normal wear and tear in a Georgia rental property?"
    answer: "Normal wear and tear includes small nail holes from hanging pictures, gradual carpet wear from regular foot traffic, light wall scuffs, and faded paint over 3–5 years. Damage includes holes in drywall, pet stains, bleach damage to carpet, broken fixtures, or burns in flooring — anything beyond what reasonable use produces."
  - question: "When must a Georgia landlord conduct the move-out inspection?"
    answer: "Within three business days after lease termination and vacation of the premises, whichever occurs first. The landlord compiles a written damage list with estimated dollar amounts per item. The tenant then has five business days to inspect and contest the list."
  - question: "Can I use photos instead of a written inspection form in Georgia?"
    answer: "Photos are essential documentation but they do not substitute for the written checklist. O.C.G.A. § 44-7-33 specifically requires a written list signed by both parties. Photos corroborate the written record but cannot replace it in a legal dispute."
  - question: "What is the penalty for wrongfully withholding a security deposit in Georgia?"
    answer: "A covered landlord (using a PM or owning more than 10 units) who acts in bad faith can be ordered under O.C.G.A. § 44-7-35 to pay the tenant up to three times the wrongfully withheld amount plus reasonable attorney's fees. Self-managing landlords with 10 or fewer units are not subject to the treble-damage penalty but still owe the deposit within 30 days."
howTo:
  name: "How to Conduct a Move-In Inspection for a Georgia Rental Property"
  description: "Step-by-step process for CSRA landlords to document property condition before a tenant takes possession, protecting the security deposit and complying with O.C.G.A. § 44-7-33."
  totalTime: "PT2H"
  steps:
    - name: "Schedule the inspection at move-in day"
      text: "Conduct the inspection on the day you hand over keys, once the unit is clean and empty. Inspecting while cleaning is still in progress or with prior tenant belongings present creates documentation gaps."
    - name: "Prepare a room-by-room checklist form"
      text: "Use a form with a condition rating scale — Good, Fair, Needs Repair — and a notes field for every surface, fixture, and appliance. A rating scale with written notes outperforms a simple pass/fail checklist."
    - name: "Walk the property from outside in"
      text: "Start with the exterior — foundation, siding, roof visible from grade, driveway, yard, and garage — then move room by room through the interior. Document every existing blemish, even minor ones, because anything undocumented at move-in can be attributed to the tenant at move-out."
    - name: "Take timestamped photographs"
      text: "Photograph every room from at least two angles and take close-up photos of any existing damage. Your phone's automatic timestamp is sufficient. Photograph appliance model and serial numbers."
    - name: "Have both parties sign the form"
      text: "Both landlord (or property manager) and tenant sign and date the completed checklist before the tenant takes possession. Provide the tenant a copy. Under O.C.G.A. § 44-7-33, the signed list is conclusive evidence of property condition at move-in."
    - name: "Store documentation for the life of the tenancy"
      text: "Keep the signed checklist and all photos throughout the tenancy and for at least 30 days after the security deposit is returned or the dispute is resolved. This is your evidence if the case reaches magistrate court."
---

<div class="snippet-box">

**What does Georgia law require for move-in and move-out inspections?**
Under O.C.G.A. § 44-7-33, Georgia landlords who use a property management company or own more than 10 rental units must provide tenants with a signed written list of existing defects before move-in. At move-out, the landlord has three business days to inspect and compile a written damage list. Skipping either step can make it legally difficult — often impossible — to keep any portion of the security deposit, even for damage the tenant actually caused.
...
The answer depends on your situation — and the distinction matters. [O.C.G.A. § 44-7-33](https://law.justia.com/codes/georgia/title-44/chapter-7/article-2/section-44-7-33/) establishes formal move-in and move-out inspection procedures for Georgia landlords, but [§ 44-7-36](https://law.justia.com/codes/georgia/2021/title-44/chapter-7/article-2/section-44-7-36/) limits who the statute covers.
...
Use [McBride PM's Move-Out Inspection Checklist](/pdfs/McBride-PM_Move-Out-Inspection-Checklist.pdf) alongside the move-in form for a direct side-by-side comparison of every room and system.
...
For detailed answers about the deposit cycle — including certified mail requirements and what to do when a tenant's forwarding address is unknown — see our [owner FAQ hub](/owner-faqs/).

## Security Deposit Deductions: What O.C.G.A. § 44-7-34 Allows

Under [O.C.G.A. § 44-7-34](https://law.justia.com/codes/georgia/title-44/chapter-7/article-2/section-44-7-34/), permissible deductions from a security deposit include:
...
Our guide to [security deposit best practices for Augusta landlords](/blog/security-deposit-best-practices-georgia/) covers the full deposit management cycle from collection to return.

## How McBride Property Management Handles Inspections on Owner Behalf

When you bring a property to McBride Property Management — whether it's in [Evans](/evans/), [Grovetown](/grovetown/), Augusta city, or anywhere across the CSRA — the inspection process is handled as a standard operational requirement, not a best-effort exercise.
...
Noah McBride and the McBride PM team currently manage approximately 208 rental doors across the Central Savannah River Area. Our [CSRA Landlord Field Guide](/pdfs/McBride-PM_CSRA-Landlord-Field-Guide.pdf) covers the full operational framework for owners who want to understand how professionally managed properties handle Georgia's landlord-tenant requirements.

For more on the legal context governing your Augusta-area rental, read our complete guide to [Georgia's Safe at Home Act](/blog/georgia-safe-at-home-act-landlord-guide-augusta-ga/) and the [lease clauses every CSRA landlord needs in 2026](/blog/georgia-lease-agreement-clauses-csra-landlords-2026/). If you're still deciding whether professional management makes financial sense, our [true cost of self-managing guide](/blog/true-cost-self-managing-rental-property-csra/) runs the full math on time, vacancy, vendor markups, and compliance risk.

<div class="faq-section">
<div class="faq-item">
<div class="faq-question">Does Georgia law require a move-in inspection?</div>
<div class="faq-answer">Yes — for landlords who own more than 10 rental units or who use a property management company. Under O.C.G.A. § 44-7-33 (read with the § 44-7-36 exemption), these landlords must provide a written list of existing defects to the tenant before they take possession, signed by both parties.</div>
</div>
<div class="faq-item">
<div class="faq-question">What happens if I skip the move-in inspection in Georgia?</div>
<div class="faq-answer">For covered landlords, failing to provide the initial defect list under § 44-7-33 makes it legally difficult — and often impossible — to withhold any portion of the security deposit for damages at move-out. Courts routinely rule for tenants when no signed baseline exists.</div>
</div>
<div class="faq-item">
<div class="faq-question">How long does a Georgia landlord have to return the security deposit?</div>
<div class="faq-answer">30 days after the landlord obtains possession of the premises. Under O.C.G.A. § 44-7-34, the landlord must return the deposit or deliver an itemized written statement of deductions within that window, sent to the tenant's last known address.</div>
</div>
<div class="faq-item">
<div class="faq-question">What can a Georgia landlord deduct from the security deposit?</div>
<div class="faq-answer">Unpaid rent, unpaid utility charges the tenant was responsible for, damage beyond normal wear and tear, cleaning required above move-in condition, unpaid late fees, and pet damage when a pet addendum was in effect. Georgia law explicitly prohibits deducting for ordinary wear and tear.</div>
</div>
<div class="faq-item">
<div class="faq-question">What is normal wear and tear in a Georgia rental property?</div>
<div class="faq-answer">Normal wear and tear includes small nail holes from hanging pictures, gradual carpet wear from regular foot traffic, light wall scuffs, and faded paint over 3–5 years. Damage includes holes in drywall, pet stains, bleach damage to carpet, broken fixtures, or burns in flooring — anything beyond what reasonable use produces.</div>
</div>
<div class="faq-item">
<div class="faq-question">When must a Georgia landlord conduct the move-out inspection?</div>
<div class="faq-answer">Within three business days after lease termination and vacation of the premises, whichever occurs first. The landlord compiles a written damage list with estimated dollar amounts per item. The tenant then has five business days to inspect and contest the list.</div>
</div>
<div class="faq-item">
<div class="faq-question">Can I use photos instead of a written inspection form in Georgia?</div>
<div class="faq-answer">Photos are essential documentation but they do not substitute for the written checklist. O.C.G.A. § 44-7-33 specifically requires a written list signed by both parties. Photos corroborate the written record but cannot replace it in a legal dispute.</div>
</div>
<div class="faq-item">
<div class="faq-question">What is the penalty for wrongfully withholding a security deposit in Georgia?</div>
<div class="faq-answer">A covered landlord (using a PM or owning more than 10 units) who acts in bad faith can be ordered under O.C.G.A. § 44-7-35 to pay the tenant up to three times the wrongfully withheld amount plus reasonable attorney's fees. Self-managing landlords with 10 or fewer units are not subject to the treble-damage penalty but still owe the deposit within 30 days.</div>
</div>
</div>
