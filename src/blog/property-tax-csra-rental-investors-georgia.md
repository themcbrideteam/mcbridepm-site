---
title: "Property Taxes on CSRA Rental Properties: An Investor's Complete Guide"
description: "Columbia County millage rates, Georgia's 40% assessment rule, and how HB 581 affects investor-owned rentals. The property tax math every CSRA rental buyer must run before closing."
date: 2026-06-23
category: "Property Owners"
readTime: "10"
keywords: ["property tax rental property Augusta GA", "CSRA rental property tax guide", "Columbia County millage rate rental investor", "Georgia non-homestead property tax", "rental property NOI property tax CSRA"]
image: "/images/blog/property-tax-csra-rental-investors-georgia.jpg"
imageAlt: "Property tax document and calculator beside a house key on a wooden home office desk in warm afternoon light"
author: "Noah McBride"
authorTitle: "Principal Broker"
faqs:
  - question: "Do rental properties in Georgia qualify for a homestead exemption?"
    answer: "No. Georgia's homestead exemption applies only to owner-occupied primary residences. Rental and investment properties are taxed on their full 40% assessed value with no homestead reduction — no exceptions."
  - question: "How are property taxes calculated on a rental in Columbia County, GA?"
    answer: "Fair market value × 40% = assessed value. Assessed value × the applicable millage rate ÷ 1,000 = annual tax. Columbia County's current combined millage in unincorporated areas is 25.6967 mills. On a $220,000 rental that works out to roughly $2,261 per year."
  - question: "Does Georgia's HB 581 floating homestead cap apply to investor-owned rentals?"
    answer: "No. HB 581's inflation-linked assessment cap, effective January 1, 2025, protects only homesteaded owner-occupied properties. Investor-owned rentals remain subject to full market reassessment every year without a ceiling on how much assessed value can increase."
  - question: "How does South Carolina tax rental properties differently from Georgia?"
    answer: "South Carolina uses a 6% assessment ratio for non-owner-occupied rental properties versus Georgia's 40% of fair market value. South Carolina compensates with much higher millage rates — Aiken County's combined rate runs around 238 mills — so the net effective tax burden is often higher than Columbia County, GA."
  - question: "When are property taxes due in Columbia County and Richmond County?"
    answer: "Property taxes in both Columbia County and Richmond County/Augusta are generally due by December 20 of the year billed. Bills are typically mailed in August or September following the January 1 assessment date."
  - question: "Can I appeal my property tax assessment on a CSRA rental property?"
    answer: "Yes. Georgia property owners have 45 days from the Notice of Assessment to file an appeal with the county Board of Equalization. The strongest argument for rentals is a comparable-sales analysis showing the county's value exceeds actual market prices."
---

<div class="snippet-box">

**What property taxes will you owe on a CSRA rental property in Georgia?**
Georgia taxes rental properties at 40% of fair market value with no homestead exemption. In Columbia County, the unincorporated combined millage rate is 25.6967 mills — roughly $2,261 annually on a $220,000 rental. Richmond County/Augusta runs slightly higher at approximately 28.849 mills. Georgia's new HB 581 assessment cap does not apply to investor-owned rentals.
...
**Columbia County — unincorporated areas (Evans, Martinez, Grovetown, Harlem):**
Columbia County's combined millage rate in unincorporated areas is currently **25.6967 mills**, per the county's published tax calculation data. Incorporated areas within Columbia County — where city levies stack on top of the county and school rates — carry a combined rate of **27.937 mills**.
...
Augusta-Richmond County carries a combined millage rate of approximately **28.849 mills** based on the county's most recently published [tax digest data](https://arctax.com/property/millage-rates/). Same $220,000 property:
- Assessed value: $220,000 × 40% = **$88,000**
...
<figure class="blog-figure">
  <img src="/images/blog/property-tax-csra-rental-investors-georgia-2.jpg" alt="Well-maintained brick ranch home on a manicured residential street in Evans Georgia at golden hour" loading="lazy" width="1408" height="768">
</figure>
...
If you're looking at properties across the Savannah River in [North Augusta](/north-augusta/) or [Aiken](/aiken/), the mechanics change significantly — because South Carolina's property tax system is built on a fundamentally different structure.

**Georgia:** Rental properties are assessed at **40% of fair market value**.
**South Carolina:** Non-owner-occupied rental properties are assessed at **6% of fair market value**.
...
Aiken County's combined millage rate for rental property in unincorporated areas runs approximately **238 mills**, according to the [Aiken County Taxpayer's Guide](https://www.aikencountysc.gov/163/Taxpayers-Guide). The City of Aiken adds another **60 mills** for incorporated parcels, pushing the combined rate to roughly 298 mills within city limits.
...
<figure class="blog-figure">
  <img src="/images/blog/property-tax-csra-rental-investors-georgia-3.jpg" alt="Open laptop displaying a financial dashboard on a kitchen table with a coffee mug and morning window light" loading="lazy" width="1408" height="768">
</figure>
...
**1. Get the current assessed value directly from the county assessor, not from Zillow.** Both [Columbia County](https://www.columbiacountyga.gov/196/Tax-Calculation-Process-Tax-Worksheet) and Richmond County maintain searchable public records of current assessed values and tax bills. Pull the actual assessment for any parcel you're considering before you model the expenses.
...
The [Georgia Department of Revenue's property tax FAQ](https://dor.georgia.gov/property-tax-real-and-personal-property-faq) covers the statutory appeal process in plain language. Both Columbia County and Richmond County publish assessment appeal forms on their tax commissioner websites.
...
<div class="faq-item">
<div class="faq-question">Do rental properties in Georgia qualify for a homestead exemption?</div>
<div class="faq-answer">No. Georgia's homestead exemption applies only to owner-occupied primary residences. Rental and investment properties are taxed on their full 40% assessed value with no homestead reduction — no exceptions.</div>
</div>
<div class="faq-item">
<div class="faq-question">How are property taxes calculated on a rental in Columbia County, GA?</div>
<div class="faq-answer">Fair market value × 40% = assessed value. Assessed value × the applicable millage rate ÷ 1,000 = annual tax. Columbia County's current combined millage in unincorporated areas is 25.6967 mills. On a $220,000 rental that works out to roughly $2,261 per year.</div>
</div>
<div class="faq-item">
<div class="faq-question">Does Georgia's HB 581 floating homestead cap apply to investor-owned rentals?</div>
<div class="faq-answer">No. HB 581's inflation-linked assessment cap, effective January 1, 2025, protects only homesteaded owner-occupied properties. Investor-owned rentals remain subject to full market reassessment every year without a ceiling on how much assessed value can increase.</div>
</div>
<div class="faq-item">
<div class="faq-question">How does South Carolina tax rental properties differently from Georgia?</div>
<div class="faq-answer">South Carolina uses a 6% assessment ratio for non-owner-occupied rental properties versus Georgia's 40% of fair market value. South Carolina compensates with much higher millage rates — Aiken County's combined rate runs around 238 mills — so the net effective tax burden is often higher than Columbia County, GA.</div>
</div>
<div class="faq-item">
<div class="faq-question">When are property taxes due in Columbia County and Richmond County?</div>
<div class="faq-answer">Property taxes in both Columbia County and Richmond County/Augusta are generally due by December 20 of the year billed. Bills are typically mailed in August or September following the January 1 assessment date.</div>
</div>
<div class="faq-item">
<div class="faq-question">Can I appeal my property tax assessment on a CSRA rental property?</div>
<div class="faq-answer">Yes. Georgia property owners have 45 days from the Notice of Assessment to file an appeal with the county Board of Equalization. The strongest argument for rentals is a comparable-sales analysis showing the county's value exceeds actual market prices.</div>
</div>
</div>
