---
title: "Summer Maintenance Checklist for Augusta-Area Rental Properties"
...
**What summer maintenance should Augusta-area landlords handle before the heat arrives?**
...
Under Georgia's habitability standards, landlords are required to maintain the structure, electrical systems, plumbing, and heating in good working condition. The [Georgia Landlord-Tenant Handbook](https://dca.georgia.gov/housing-choice-voucher/landlords/georgia-landlord-tenant-handbook) outlines your obligations, and recent updates under the Safe at Home Act have formalized minimum habitability standards that include safe plumbing, working heating and cooling, secure windows and doors, and properties free of infestations.

For South Carolina properties in Aiken County or Edgefield County, landlord obligations are governed by the [SC Residential Landlord and Tenant Act](https://www.scstatehouse.gov/code/t27c040.php), which has its own set of maintenance requirements.
...
<div class="faq-item">
<div class="faq-question">Q: When should I schedule HVAC maintenance on my Augusta rental property?</div>
<div class="faq-answer">Schedule your annual cooling system tune-up in March or April, before the summer rush. This gives you time to address any issues before temperatures climb and HVAC contractors are booked out for weeks. At minimum, replace air filters before May and again every 30 to 60 days through the summer.</div>
</div>
<div class="faq-item">
<div class="faq-question">Q: Am I legally required to provide air conditioning in a Georgia rental property?</div>
<div class="faq-answer">Georgia law requires landlords to maintain heating systems, but air conditioning obligations depend on whether the unit was provided at lease signing. If the property had a working AC system when the tenant moved in, you're generally required to maintain it in working condition. The Georgia DCA's Landlord-Tenant Handbook provides detailed guidance on habitability standards.</div>
</div>
<div class="faq-item">
<div class="faq-question">Q: How much does a typical summer maintenance inspection cost for a rental property?</div>
<div class="faq-answer">A basic HVAC tune-up runs $75 to $150 per unit. Gutter cleaning typically costs $100 to $200. A full property walk-through inspection by a property manager is often included in your management agreement. All told, proactive summer maintenance usually costs a few hundred dollars — compared to thousands for emergency repairs.</div>
</div>
<div class="faq-item">
<div class="faq-question">Q: What summer maintenance tasks should tenants handle versus the landlord?</div>
<div class="faq-answer">Tenants are generally responsible for changing air filters (if your lease specifies this), keeping the property clean, reporting maintenance issues promptly, and basic yard upkeep. Landlords handle structural maintenance, HVAC servicing, pest control bonds, roof and gutter maintenance, and any repairs needed to maintain habitability.</div>
</div>
</div>
