---
title: "Georgia Lease Agreement Clauses Every CSRA Landlord Needs in 2026"
description: "What CSRA landlords must include in a Georgia residential lease in 2026: required disclosures, Safe at Home Act clauses, late fees, entry notice, and what to avoid."
date: 2026-06-24
category: "Property Owners"
readTime: "10"
keywords: ["Georgia lease agreement landlord", "CSRA lease clauses 2026", "Georgia residential lease requirements", "Augusta GA landlord lease", "Safe at Home Act lease Georgia"]
image: "/images/blog/georgia-lease-agreement-clauses-csra-landlords-2026.jpg"
imageAlt: "Open residential lease agreement with fountain pen on a clean wooden desk in warm afternoon light, Augusta GA rental property"
socialImage: "/images/blog/georgia-lease-agreement-clauses-csra-landlords-2026-social.jpg"
socialImageAlt: "Brass house key on folded lease document, warm natural light"
socialTeaser: |
  We reviewed a lease last month that a CSRA landlord had been using for three years. It had no entry notice clause, an unenforceable late-fee provision, and nothing about the Safe at Home Act's habitability warranty. Every one of those gaps is a liability.

  Georgia's lease law changed materially in July 2024. The Safe at Home Act capped security deposits at two months' rent combined, created an implied habitability warranty in every residential lease, and added a mandatory three-business-day cure notice before filing a dispossessory. If your lease was drafted before July 2024 and your tenancies have renewed since then, it may not reflect current Georgia law.

  This post walks through what the law requires, the nine clauses that protect Augusta-area landlords in practice, and what to strip out of any template you're currently using.

  Read the full breakdown →
  https://mcbride-pm.com/blog/georgia-lease-agreement-clauses-csra-landlords-2026/
author: "Noah McBride"
authorTitle: "Principal Broker"
faqs:
  - question: "Does Georgia law require landlords to give 24 hours notice before entering?"
    answer: "No. Georgia has no statutory entry notice requirement — the notice period in your lease agreement controls. Industry standard is 24 hours for non-emergency entry. McBride PM recommends including explicit entry-notice language in every lease to prevent disputes before they start."
  - question: "What is the maximum security deposit a Georgia landlord can charge in 2026?"
    answer: "Under the Safe at Home Act (HB 404, effective July 1, 2024), Georgia landlords cannot collect more than two months' rent in total refundable deposits — including pet deposits. This cap applies to leases entered or renewed on or after July 1, 2024. The deposit must be returned within 30 days of move-out."
  - question: "Does Georgia law cap late fees for rental properties?"
    answer: "No. Georgia has no statutory cap on residential late fees, but courts apply a reasonableness standard. A late fee of 5%–10% of monthly rent is generally defensible. The amount, the grace period, and the trigger date must all be clearly stated in the lease or the provision may be unenforceable."
  - question: "What required disclosures must go in a Georgia lease?"
    answer: "Georgia landlords must disclose the name and address of the property owner and the person authorized to manage the premises under OCGA § 44-7-3. For homes built before 1978, federal law (42 U.S.C. § 4852d) requires a lead-based paint disclosure and the EPA pamphlet before lease signing."
  - question: "How much notice must a Georgia landlord give to end a month-to-month tenancy?"
    answer: "Under OCGA § 44-7-7, a landlord must give at least 60 days written notice to terminate a month-to-month tenancy. Tenants must give 30 days notice. Fixed-term leases are governed by the contract terms, not this statute — which is why holdover language in the lease matters."
  - question: "Can a Georgia lease waive a tenant's rights under state law?"
    answer: "No. Under OCGA § 44-7-2, any lease provision that attempts to waive a tenant's statutory rights is void and unenforceable. Landlords cannot contract around the Safe at Home Act's habitability requirements, the two-month security deposit cap, or the mandatory dispossessory cure notice."
howTo:
  name: "How to Structure a Georgia Residential Lease for CSRA Rental Properties"
  description: "A step-by-step approach to drafting or reviewing a Georgia residential lease that complies with current state law and protects the landlord's interests."
  totalTime: "P2D"
  steps:
    - name: "Confirm statutory disclosures are present"
      text: "Verify the lease identifies the property owner and authorized manager by name and address (OCGA § 44-7-3). For pre-1978 homes, add the federal lead-paint disclosure and attach the EPA pamphlet before the tenant signs."
    - name: "Add the nine protective clauses"
      text: "Include explicit provisions for late fees, entry notice, lease termination notice, maintenance request process, pet policy, utility assignments, subleasing prohibition, holdover terms, and rent escalation."
    - name: "Update security deposit language for HB 404"
      text: "Cap total refundable deposits at two months' rent combined and specify that funds will be returned within 30 days of move-out with a written itemized deduction statement."
    - name: "Remove void clauses"
      text: "Delete any provision that waives tenant repair rights, allows self-help eviction, or charges penalties a Georgia court would find unreasonable or unconscionable."
    - name: "Have a Georgia-licensed attorney or licensed property manager review the final document"
      text: "Georgia lease requirements interact with federal law and local eviction procedures. A qualified review catches gaps that a generic template won't flag."
---

<div class="snippet-box">

**What clauses does a Georgia residential lease need to include in 2026?**
...
This is not optional. Under [OCGA § 44-7-3](https://law.justia.com/codes/georgia/title-44/chapter-7/article-1/section-44-7-3/), a landlord who fails to provide this disclosure cannot enforce any lease provision requiring the tenant to notify the landlord of conditions or needed repairs. Any changes to this information must be communicated to tenants within 30 days.
...
The lead-paint disclosure requirement is federal, not Georgia, law — [42 U.S.C. § 4852d](https://www.epa.gov/lead/lead-based-paint-disclosure-rule-section-1018-title-x), part of the Residential Lead-Based Paint Hazard Reduction Act. For any home built before 1978:
...
Before July 1, 2024, Georgia was one of a small number of states without a formal statutory warranty of habitability in residential leases. The [Safe at Home Act changed that](https://nlihc.org/resource/georgia-passes-new-tenant-protection-law-renters-establishing-minimum-habitability). Under OCGA § 44-7-13(b) as amended, every residential lease entered or renewed after that date carries an implied warranty that the premises are fit for human habitation and maintained in compliance with applicable building codes affecting health and safety.

That warranty cannot be waived. Under [OCGA § 44-7-2](https://law.justia.com/codes/georgia/title-44/chapter-7/article-1/section-44-7-2/), any lease clause that attempts to waive a tenant's statutory rights is void. A clause reading "Tenant accepts property in as-is condition with no representations by Landlord" will not protect you from a habitability claim. For a full breakdown of what the Safe at Home Act requires landlords to maintain, see our [Georgia Safe at Home Act guide for Augusta-area landlords](/blog/georgia-safe-at-home-act-landlord-guide-augusta-ga/).
...
This is the most consistently misunderstood provision in Georgia landlord-tenant law. Georgia has no statute requiring advance notice before a landlord enters a rental property — [not 24 hours, not 48 hours, nothing](https://innago.com/georgia-landlord-tenant-laws/). The entry rights are governed entirely by the lease.
...
Our [pet policy guide for Augusta-area landlords](/blog/pet-policy-rental-property-augusta-ga-landlord-guide/) walks through the full fee structure and service animal accommodation process, including documentation you can request and what you cannot.
...
For the full mechanics of Georgia's deposit return rules — itemized deductions, allowable charges versus normal wear, and documentation to protect yourself — see our [security deposit best practices guide for Augusta-area landlords](/blog/security-deposit-best-practices-georgia/).
...
For the full step-by-step walkthrough of Georgia's dispossessory process, including how Columbia County and Richmond County Magistrate Courts handle these filings, see our [Georgia eviction process guide for Augusta-area landlords](/blog/georgia-eviction-process-landlord-guide/).
...
Working with a licensed property manager provides ongoing compliance. McBride PM maintains Georgia-compliant leases for all managed properties — provisions tested against Augusta-area court standards. Amber McBride handles tenant onboarding and lease execution as part of our standard management process, which means every tenancy starts with current, properly executed documents. Property management fees are fully deductible against rental income, which often narrows the cost gap significantly when small landlords run the true comparison. Our [guide to the true cost of self-managing a CSRA rental property](/blog/true-cost-self-managing-rental-property-csra/) runs the full math.

The Augusta-area rental market rewards landlords who operate professionally. Two-bedroom rents in Columbia County are running $1,259–$1,353 according to [RentCafe's mid-2026 market data](https://www.rentcafe.com/average-rent-market-trends/us/ga/augusta/). Tenants signing leases at those rates have options and are sophisticated enough to notice when a landlord's lease doesn't reflect current law.

<figure class="blog-figure">
  <img src="/images/blog/georgia-lease-agreement-clauses-csra-landlords-2026-3.jpg" alt="Freshly-painted bright living room interior with hardwood floors and warm afternoon light through tall windows in a CSRA rental" loading="lazy" width="1408" height="768">
</figure>
...
For a broader reference on Georgia residential landlord-tenant law — including security deposit rules, the eviction process, and habitability requirements — download the [McBride PM CSRA Landlord Field Guide](/pdfs/McBride-PM_CSRA-Landlord-Field-Guide.pdf). It covers the full landlord lifecycle for Augusta-area rental owners and reflects the Safe at Home Act changes.

---

<div class="faq-section">
<div class="faq-item">
<div class="faq-question">Does Georgia law require landlords to give 24 hours notice before entering?</div>
<div class="faq-answer">No. Georgia has no statutory entry notice requirement — the notice period in your lease agreement controls. Industry standard is 24 hours for non-emergency entry. McBride PM recommends including explicit entry-notice language in every lease to prevent disputes before they start.</div>
</div>
<div class="faq-item">
<div class="faq-question">What is the maximum security deposit a Georgia landlord can charge in 2026?</div>
<div class="faq-answer">Under the Safe at Home Act (HB 404, effective July 1, 2024), Georgia landlords cannot collect more than two months' rent in total refundable deposits — including pet deposits. This cap applies to leases entered or renewed on or after July 1, 2024. The deposit must be returned within 30 days of move-out.</div>
</div>
<div class="faq-item">
<div class="faq-question">Does Georgia law cap late fees for rental properties?</div>
<div class="faq-answer">No. Georgia has no statutory cap on residential late fees, but courts apply a reasonableness standard. A late fee of 5%–10% of monthly rent is generally defensible. The amount, the grace period, and the trigger date must all be clearly stated in the lease or the provision may be unenforceable.</div>
</div>
<div class="faq-item">
<div class="faq-question">What required disclosures must go in a Georgia lease?</div>
<div class="faq-answer">Georgia landlords must disclose the name and address of the property owner and the person authorized to manage the premises under OCGA § 44-7-3. For homes built before 1978, federal law (42 U.S.C. § 4852d) requires a lead-based paint disclosure and the EPA pamphlet before lease signing.</div>
</div>
<div class="faq-item">
<div class="faq-question">How much notice must a Georgia landlord give to end a month-to-month tenancy?</div>
<div class="faq-answer">Under OCGA § 44-7-7, a landlord must give at least 60 days written notice to terminate a month-to-month tenancy. Tenants must give 30 days notice. Fixed-term leases are governed by the contract terms, not this statute — which is why holdover language in the lease matters.</div>
</div>
<div class="faq-item">
<div class="faq-question">Can a Georgia lease waive a tenant's rights under state law?</div>
<div class="faq-answer">No. Under OCGA § 44-7-2, any lease provision that attempts to waive a tenant's statutory rights is void and unenforceable. Landlords cannot contract around the Safe at Home Act's habitability requirements, the two-month security deposit cap, or the mandatory dispossessory cure notice.</div>
</div>
</div>
