---
title: "What to Look for in a Tenant Screening Process"
description: "A thorough tenant screening process protects Augusta, GA landlords from costly evictions and property damage. Here's what every screening should include."
date: 2026-04-03
...
Learn more about how McBride Property Management screens tenants and manages properties across the Augusta area on our [services page](/services/). Or if you're ready to talk, [reach out directly](/contact/) — we'll walk you through exactly how we protect your investment from the application stage forward.

For more owner education, browse our full [blog archive](/blog/).
...
<div class="faq-section">
  <div class="faq-item">
    <div class="faq-question">Q: What does a tenant screening process typically include?</div>
    <div class="faq-answer">A thorough tenant screening process includes five core components: a credit history review, a criminal background check, income and employment verification, rental history references from previous landlords, and an eviction records search. Each element reveals different risk factors, and skipping any one of them leaves a gap that can lead to costly tenant problems down the line.</div>
  </div>
  <div class="faq-item">
    <div class="faq-question">Q: Can a landlord in Georgia deny a tenant based on criminal history?</div>
