---
title: "When Your CSRA Tenant Stops Paying Rent: Fort Gordon PCS Playbook"
description: "Georgia PCS landlord guide: 3-day notice rules, the Columbia County dispossessory process, SCRA military tenant wrinkles, and why remote management changes everything."
date: 2026-07-09
category: "Property Owners"
readTime: "11"
keywords: ["tenant not paying rent Georgia PCS landlord", "Georgia dispossessory process Fort Gordon landlord", "CSRA non-payment eviction 2026", "remote landlord tenant non-payment Georgia", "Fort Gordon PCS rental property eviction"]
socialTeaser: |
  Three months after PCS, your tenant skipped rent. You're 1,200 miles away — now what?

  Georgia's dispossessory process starts with a mandatory written notice giving the tenant exactly 3 business days to pay or vacate (O.C.G.A. § 44-7-50(c), amended by the Safe at Home Act). If they don't pay, you file at the Columbia County Magistrate Court. An uncontested case resolves in 3 to 6 weeks. A contested one — or one where the tenant raises a habitability defense — can run 2 to 4 months.

  The biggest mistake remote PCS landlords make: texting the tenant instead of having a local agent serve proper written notice on day one. That delay costs weeks.

  Read the full breakdown →
  https://mcbride-pm.com/blog/non-paying-tenant-fort-gordon-pcs-landlord-georgia/
author: "Noah McBride"
authorTitle: "Principal Broker"
faqs:
  - question: "How long does the Georgia eviction process take for non-payment of rent?"
    answer: "An uncontested non-payment dispossessory in Georgia typically takes 3 to 6 weeks from the date of written notice through physical possession. A contested case — where the tenant files an answer, requests a hearing, or appeals — can take 2 to 4 months or longer. Procedural errors that require restarting the notice process add more time on top."
  - question: "What notice is required before filing a dispossessory in Georgia for non-payment?"
    answer: "Under O.C.G.A. § 44-7-50(c), as amended by the Safe at Home Act (HB 404, effective July 1, 2024), landlords must serve a written demand to pay or vacate and allow 3 full business days before filing. Texts and emails do not satisfy the requirement — notice must be physically delivered or posted on the door in a sealed envelope."
  - question: "Can I change the locks or shut off utilities if a tenant stops paying rent in Georgia?"
    answer: "No. Self-help eviction — changing locks, removing doors, or cutting off utilities including air conditioning — is illegal in Georgia under O.C.G.A. § 44-7-14.1. Doing so exposes you to a $500 fine, potential criminal liability, and a tenant counterclaim that can derail your dispossessory. You must complete the court process before reclaiming possession."
  - question: "What if my non-paying tenant is an active-duty soldier?"
  ...
  - question: "Do I have to be in Georgia to file a dispossessory?"
    answer: "No. Georgia law allows a property manager, attorney, or authorized agent to sign and file a dispossessory affidavit on your behalf. If your property is in Columbia County — Grovetown, Evans, or Martinez — the filing goes to the Columbia County Magistrate Court. A local property manager handles the entire process without requiring you to fly back to Augusta."
  - question: "What happens if my tenant pays all back rent after I file a dispossessory?"
    answer: "Under O.C.G.A. § 44-7-52(a), a tenant who tenders all overdue rent plus court costs within 7 days of being served the dispossessory summons has a complete defense — the case is dismissed. This 'tender defense' can only be used once per 12-month period per tenant, so a second delinquency within the same lease year removes the option."
howTo:
  name: "How to Handle a Non-Paying Tenant as a Fort Gordon PCS Landlord in Georgia"
  description: "The legal process for pursuing a dispossessory in Georgia when your CSRA tenant stops paying rent while you are stationed elsewhere."
  totalTime: "P45D"
  steps:
    - name: "Verify non-payment and attempt one documented contact"
      text: "Confirm rent has not been received in your AppFolio account or bank. Attempt one phone call or email and document the date and response. This is not a legal requirement but documents good faith and may surface a simple bank transfer error."
    - name: "Have a local agent serve written notice on day one"
      text: "On the first business day after your lease grace period expires, have your property manager or attorney post a written demand to pay or vacate in a sealed envelope on the tenant's door. The notice must state the full amount owed and give exactly 3 business days to comply, per O.C.G.A. § 44-7-50(c). Photograph the posting with a timestamp."
    - name: "File the dispossessory affidavit after the notice window closes"
      text: "If the tenant has not paid or vacated by end of the third business day, your agent files a dispossessory affidavit at the appropriate county court — Columbia County Magistrate Court for Grovetown, Evans, or Martinez properties; Augusta-Richmond County Civil Court for Augusta-proper properties. Attach the signed lease and the notice documentation."
    - name: "Monitor the tenant's 7-day answer window"
      text: "Once the court serves the dispossessory summons, the tenant has 7 days to file a written answer. If no answer is filed, request a default judgment on day 8. If an answer is filed, the court schedules a hearing typically 15 to 21 days after the original filing."
    - name: "Appear or send authorized representation to the hearing"
      text: "Bring the signed lease, written notice with proof of service, rent payment records, and maintenance documentation. Under the Safe at Home Act's implied warranty of habitability, unresolved maintenance claims can be raised as an affirmative defense — your maintenance records are your protection."
    - name: "Obtain the writ of possession and coordinate sheriff enforcement"
      text: "After judgment, the writ is issued. The tenant has 7 days to appeal per O.C.G.A. § 44-7-56. If no appeal is filed, apply to the sheriff within 30 days to execute the writ. Your property manager coordinates the lockout and begins the make-ready process."
---

<div class="snippet-box">

**What should a Fort Gordon PCS landlord do when a tenant stops paying rent in Georgia?**
Serve written notice immediately — Georgia law requires a 3-business-day demand to pay or vacate under [O.C.G.A. § 44-7-50(c)](https://law.justia.com/codes/georgia/title-44/chapter-7/article-3/section-44-7-50/) before filing a dispossessory. If the tenant doesn't pay within those 3 days, file at the Columbia County Magistrate Court. An uncontested case resolves in 3 to 6 weeks; a local property manager can handle every step without requiring you to return to Augusta.
...
If your lease was signed or renewed after July 1, 2024, the [Georgia Safe at Home Act (HB 404)](https://gaappleseed.org/resource/safeathome/) introduced changes that directly affect how non-payment cases proceed.
...
The non-negotiable step: before filing a dispossessory against any tenant, verify their active-duty status through the [Department of Defense SCRA verification database at scra.dmdc.osd.mil](https://scra.dmdc.osd.mil/). This check takes under two minutes. Proceeding against a protected active-duty servicemember without checking can result in federal penalties and criminal exposure. Military landlords often assume they understand SCRA because they've been subject to it themselves — but the statute applies symmetrically regardless of the landlord's status.

Our post on [SCRA lease terminations and what Fort Gordon landlords must know](/blog/scra-lease-termination-fort-gordon-landlord-guide/) covers the broader SCRA landscape, including early termination rights for military tenants receiving PCS or deployment orders — a related but distinct issue from non-payment.
...
For more on how the Columbia County rental landscape differs from Augusta-proper in terms of both landlord operations and market dynamics, see our [Evans, Grovetown, and Martinez rental investment guide](/blog/evans-grovetown-martinez-augusta-csra-rental-investment-guide/) and the [Evans city page](/evans/).
...
For the full picture of building operational infrastructure that makes situations like this manageable whether you're in Evans or in Germany, the [CSRA Rental Emergency Playbook for PCS Landlords](/blog/csra-rental-emergency-playbook-pcs-landlords/) goes deeper on what to have in place before an emergency, not during it.
...
The [Operating Expenses Worksheet](/pdfs/McBride-PM_Operating-Expenses-Worksheet.pdf) includes CSRA-benchmarked reserve target lines alongside the other operating expense categories — CapEx, maintenance, vacancy — that PCS landlords often undercount when projecting rental income.

And on the front end: proper tenant screening is the best insurance against reaching this process in the first place. Our post on [what to look for in a tenant screening process](/blog/tenant-screening-process-augusta-ga-landlords/) covers the specific criteria that reduce non-payment risk in the Fort Gordon tenant pool.
...
<div class="faq-item">
<div class="faq-question">How long does the Georgia eviction process take for non-payment of rent?</div>
<div class="faq-answer">An uncontested non-payment dispossessory in Georgia typically takes 3 to 6 weeks from the date of written notice through physical possession. A contested case — where the tenant files an answer, requests a hearing, or appeals — can take 2 to 4 months or longer. Procedural errors that require restarting the notice process add more time on top.</div>
</div>
<div class="faq-item">
<div class="faq-question">What notice is required before filing a dispossessory in Georgia for non-payment?</div>
<div class="faq-answer">Under O.C.G.A. § 44-7-50(c), as amended by the Safe at Home Act (HB 404, effective July 1, 2024), landlords must serve a written demand to pay or vacate and allow 3 full business days before filing. Texts and emails do not satisfy the requirement — notice must be physically delivered or posted on the door in a sealed envelope.</div>
</div>
<div class="faq-item">
<div class="faq-question">Can I change the locks or shut off utilities if a tenant stops paying rent in Georgia?</div>
<div class="faq-answer">No. Self-help eviction — changing locks, removing doors, or cutting off utilities including air conditioning — is illegal in Georgia under O.C.G.A. § 44-7-14.1. Doing so exposes you to a $500 fine, potential criminal liability, and a tenant counterclaim that can derail your dispossessory. You must complete the court process before reclaiming possession.</div>
</div>
<div class="faq-item">
<div class="faq-question">What if my non-paying tenant is an active-duty soldier?</div>
<div class="faq-answer">The Servicemembers Civil Relief Act allows an active-duty military tenant to request a court postponement of up to 3 months if military service materially affected their ability to pay. Before filing a dispossessory against any tenant, verify their active-duty status at scra.dmdc.osd.mil. Proceeding against a protected servicemember without checking can result in federal penalties.</div>
</div>
<div class="faq-item">
<div class="faq-question">Do I have to be in Georgia to file a dispossessory?</div>
<div class="faq-answer">No. Georgia law allows a property manager, attorney, or authorized agent to sign and file a dispossessory affidavit on your behalf. If your property is in Columbia County — Grovetown, Evans, or Martinez — the filing goes to the Columbia County Magistrate Court. A local property manager handles the entire process without requiring you to fly back to Augusta.</div>
</div>
<div class="faq-item">
<div class="faq-question">What happens if my tenant pays all back rent after I file a dispossessory?</div>
<div class="faq-answer">Under O.C.G.A. § 44-7-52(a), a tenant who tenders all overdue rent plus court costs within 7 days of being served the dispossessory summons has a complete defense — the case is dismissed. This 'tender defense' can only be used once per 12-month period per tenant, so a second delinquency within the same lease year removes the option.</div>
</div>
</div>
