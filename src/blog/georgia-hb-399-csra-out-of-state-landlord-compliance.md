---
title: "Georgia HB 399 Compliance Guide for CSRA Out-of-State Landlords"
description: "Georgia HB 399 requires out-of-state CSRA landlords to have a licensed in-state representative. Here's exactly what the law says and how to comply."
date: 2026-06-08
category: "Property Owners"
readTime: "9"
keywords: ["Georgia HB 399 out-of-state landlord", "CSRA landlord local representative requirement", "OCGA 44-7-25 out-of-state rental owner", "Georgia licensed property manager out of state", "Augusta GA HB 399 compliance"]
image: "/images/blog/georgia-hb-399-csra-out-of-state-landlord-compliance.jpg"
imageAlt: "Well-maintained brick ranch home on a tree-lined Evans Georgia residential street in warm late-afternoon golden light"
author: "Noah McBride"
authorTitle: "Principal Broker"
faqs:
  - question: "Does Georgia HB 399 apply to Augusta and CSRA rental property owners?"
    answer: "Yes. HB 399 applies statewide to any non-resident owner of a single-family home or duplex in Georgia. If your rental property sits in Augusta, Evans, Martinez, Grovetown, or anywhere else in the CSRA and you live outside Georgia, HB 399 applies to you. The law has been in effect since July 1, 2025."
  - question: "What exactly does HB 399 require out-of-state landlords to do?"
    answer: "HB 399 amends O.C.G.A. § 44-7-25 to require non-resident owners of single-family homes or duplexes to engage a Georgia-licensed real estate broker as their local representative. That representative's name and contact information must be provided to tenants in writing. If the broker is also out of state, they must employ at least one Georgia-resident licensee for tenant communication."
  - question: "Does HB 399 apply to PCS military homeowners who rented out their home?"
    answer: "Generally yes. If a service member purchased a home near Fort Gordon, later PCS'd to another state, and is now renting that home remotely, they are a non-resident landlord of a single-family home in Georgia. HB 399 applies. The exact treatment of military Home of Record under the statute is not explicitly defined in the bill — consult a Georgia attorney for your specific situation."
  - question: "Who qualifies as a local representative under HB 399?"
    answer: "The representative must be a Georgia-licensed real estate broker or someone operating under a qualifying broker in compliance with O.C.G.A. Title 43, Chapter 40. A licensed property management company with Georgia-domiciled staff satisfies this requirement. A neighbor, friend, or unlicensed handyman does not."
  - question: "What are the penalties for not complying with HB 399?"
    answer: "The statute exposes non-compliant landlords to local enforcement actions, fines, and potential restrictions on their ability to rent the property. The law also creates a clear legal vulnerability in any tenant dispute — a landlord who cannot produce a local licensed representative will find themselves at a disadvantage before a magistrate court."
  - question: "Does HB 399 apply to duplexes and multifamily properties?"
    answer: "HB 399 explicitly covers single-family homes and duplexes. The plain text of the bill does not extend to properties with three or more units. If you own a triplex, fourplex, or larger multifamily building in Georgia, consult a Georgia real estate attorney to determine your specific obligations under existing broker-of-record and agency rules."
howTo:
  name: "How to Comply with Georgia HB 399 as a CSRA Out-of-State Landlord"
  description: "Three steps to bring your out-of-state single-family or duplex rental in Georgia into compliance with O.C.G.A. § 44-7-25 as amended by HB 399."
  totalTime: "P7D"
  steps:
    - name: "Determine whether HB 399 applies to you"
      text: "If you are a non-resident of Georgia and own a single-family home or duplex being rented in the state, HB 399 applies. This includes PCS military homeowners, inherited-property landlords who moved away, and out-of-state investors."
    - name: "Engage a Georgia-licensed real estate broker or property manager"
      text: "Hire a Georgia-licensed property management company or broker to serve as your in-state representative. The engagement should be documented in a signed management or agency agreement that clearly designates the broker as your representative for the property."
    - name: "Provide the representative's information to your tenant in writing"
      text: "Update your lease addendum or provide a standalone written disclosure to each tenant with the name, address, and contact information of the in-state representative. This is a required component of compliance under the statute — it is not sufficient to simply hire a PM without notifying the tenant."
---

<div class="snippet-box">

**Does Georgia HB 399 require out-of-state landlords in the CSRA to have a local representative?**
...
## What Georgia HB 399 Actually Says

HB 399 amends [O.C.G.A. § 44-7-25](https://law.justia.com/codes/georgia/title-44/chapter-7/), the Georgia statute governing landlord representation in residential rental relationships. Before HB 399, Georgia law had no specific requirement that non-resident landlords maintain an in-state contact. The amendment changed that.
...
<figure class="blog-figure">
  <img src="/images/blog/georgia-hb-399-csra-out-of-state-landlord-compliance-2.jpg" alt="Rental lease agreement and fountain pen on a wooden desk with a set of house keys in warm natural light" loading="lazy" width="1408" height="768">
</figure>

## Who Is a "Non-Resident" Under HB 399?
...
- You own a rental home in Evans, GA, and your primary address is in Virginia Beach.
- Your LLC, which owns a duplex in Grovetown, is registered in Delaware with a registered agent in New Jersey.
- You inherited a home in Martinez, moved to Tennessee to care for family, and have been renting the property from there.
- You bought a Columbia County single-family rental last year as an out-of-state investment.
...
For CSRA landlords who inherited properties and are managing from out of state, our [accidental landlord guide](/blog/accidental-landlord-augusta-ga-what-to-do/) covers the full picture of what you need to get right from day one. HB 399 compliance is one of the first items on that list.

## The Tenant Disclosure — What "In Writing" Requires
...
1. **In the lease addendum** — a specific paragraph naming the property manager as the landlord's authorized in-state representative, with the PM firm's name, physical address, and contact information.
2. **In a standalone disclosure document** — signed by the tenant at or before lease execution, separate from the lease itself, specifically referencing the HB 399 obligation and providing the representative's information.
...
## Why This Matters Most for Fort Gordon Homeowners on PCS
...
The compliance fix is straightforward: hire a CSRA-based property manager before the PCS happens, or immediately if it already has. The [60-day PCS landlord timeline](/blog/pcs-fort-gordon-rent-home-landlord-timeline/) we published covers the full process for converting your Fort Gordon home to a rental. Getting the PM agreement signed is step one.

<figure class="blog-figure">
  <img src="/images/blog/georgia-hb-399-csra-out-of-state-landlord-compliance-3.jpg" alt="Open laptop showing property management dashboard on a wooden desk with a cup of coffee in warm home office light" loading="lazy" width="1408" height="768">
</figure>

## The Out-of-State Investor Angle
...
For investors who haven't done the due diligence side of their CSRA acquisition yet, our [out-of-state investor guide for Augusta-area rentals](/blog/out-of-state-rental-investor-guide-augusta-ga/) covers submarket selection, remote due diligence, inspection protocols, and how to verify market rents independently. HB 399 compliance is the operating-day-one item that investment guides don't always surface clearly enough — consider this post your HB 399 supplement.
...
## How a CSRA Property Manager Satisfies HB 399 — Specifically
...
1. Confirm that you are the type of owner covered by HB 399 (non-resident, SFH or duplex).
2. Engage a Georgia-licensed property management firm or broker as your in-state representative.
3. Ensure your tenant has the representative's contact information in writing, in a signed document.
4. If you transition management companies, update the tenant disclosure.
...
You can review the full text of HB 399 as signed by [Georgia Governor Kemp in the official 2025 signed legislation archive](https://gov.georgia.gov/document/2025-signed-legislation/hb-399/download). The [CSRA Landlord Field Guide](/pdfs/McBride-PM_CSRA-Landlord-Field-Guide.pdf) is also a useful companion reference, covering the broader Georgia landlord-tenant framework including security deposit rules under the Safe at Home Act, the dispossessory process, and operating expense benchmarks for CSRA rentals.

<div class="faq-section">
<div class="faq-item">
<div class="faq-question">Does Georgia HB 399 apply to Augusta and CSRA rental property owners?</div>
<div class="faq-answer">Yes. HB 399 applies statewide to any non-resident owner of a single-family home or duplex in Georgia. If your rental property sits in Augusta, Evans, Martinez, Grovetown, or anywhere else in the CSRA and you live outside Georgia, HB 399 applies to you. The law has been in effect since July 1, 2025.</div>
</div>
<div class="faq-item">
<div class="faq-question">What exactly does HB 399 require out-of-state landlords to do?</div>
<div class="faq-answer">HB 399 amends O.C.G.A. § 44-7-25 to require non-resident owners of single-family homes or duplexes to engage a Georgia-licensed real estate broker as their local representative. That representative's name and contact information must be provided to tenants in writing. If the broker is also out of state, they must employ at least one Georgia-resident licensee for tenant communication.</div>
</div>
<div class="faq-item">
<div class="faq-question">Does HB 399 apply to PCS military homeowners who rented out their home?</div>
<div class="faq-answer">Generally yes. If a service member purchased a home near Fort Gordon, later PCS'd to another state, and is now renting that home remotely, they are a non-resident landlord of a single-family home in Georgia. HB 399 applies. The exact treatment of military Home of Record under the statute is not explicitly defined in the bill — consult a Georgia attorney for your specific situation.</div>
</div>
<div class="faq-item">
<div class="faq-question">Who qualifies as a local representative under HB 399?</div>
<div class="faq-answer">The representative must be a Georgia-licensed real estate broker or someone operating under a qualifying broker in compliance with O.C.G.A. Title 43, Chapter 40. A licensed property management company with Georgia-domiciled staff satisfies this requirement. A neighbor, friend, or unlicensed handyman does not.</div>
</div>
<div class="faq-item">
<div class="faq-question">What are the penalties for not complying with HB 399?</div>
<div class="faq-answer">The statute exposes non-compliant landlords to local enforcement actions, fines, and potential restrictions on their ability to rent the property. The law also creates a clear legal vulnerability in any tenant dispute — a landlord who cannot produce a local licensed representative will find themselves at a disadvantage before a magistrate court.</div>
</div>
<div class="faq-item">
<div class="faq-question">Does HB 399 apply to duplexes and multifamily properties?</div>
<div class="faq-answer">HB 399 explicitly covers single-family homes and duplexes. The plain text of the bill does not extend to properties with three or more units. If you own a triplex, fourplex, or larger multifamily building in Georgia, consult a Georgia real estate attorney to determine your specific obligations under existing broker-of-record and agency rules.</div>
</div>
</div>
